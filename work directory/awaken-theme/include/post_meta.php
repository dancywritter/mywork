                    ...
                    <div class="tabs vertical">
                        <nav class="admin-navigtion">
                            <ul id="myTab" class="nav nav-tabs">
                                <li class="active"><a href="#tab-general-settings" data-toggle="tab"><i class="fa fa-toggle-right"></i>General Settings</a></li>
                                <li><a href="#tab-subheader-options" data-toggle="tab"><i class="fa fa-list-alt"></i> Sub Header Options </a></li>
                                ...
                                <?php }?>
                                <li><a href="#tab-post-options" data-toggle="tab"><i class="fa fa-list-alt"></i> Post Settings </a></li>
