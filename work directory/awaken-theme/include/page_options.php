...
<ul class="form-elements">
  <li class="to-label">
    <label><?php _e('Choose Sub-header','backend');?></label>
  </li>
  <li class="to-field">
    <div class="input-sec">
      ...
      <div class="select-style">
        <select name="header_banner_style" class="dropdown" onchange="javascript:cs_slider_element_toggle(this.value)">
          <option <?php if(isset($header_banner_style) and $header_banner_style=="default_header" || $header_banner_style=="" ){echo "selected";}?> value="default_header" ><?php _e('Default Subheader','backend');?></option>
          <option <?php if(isset($header_banner_style) and $header_banner_style=="breadcrumb_header" ) {echo "selected";}?> value="breadcrumb_header" ><?php _e('Custom Subheader','backend');?></option>
          <option <?php if(isset($header_banner_style) and $header_banner_style=="custom_slider"){echo "selected";}?> value="custom_slider" ><?php _e('Revolution Slider','backend');?></option>
          <option <?php if(isset($header_banner_style) and $header_banner_style=="map"){echo "selected";}?> value="map" ><?php _e('Map','backend');?></option>
          <option <?php if(isset($header_banner_style) and $header_banner_style=="no-header"){echo "selected";}?> value="no-header" ><?php _e('No Subheader','backend');?></option>
        </select>
        <script>
...
<div id="subheader-background-image" style="display:<?php if($header_banner_style=="breadcrumb_header")echo 'inline"'; else echo 'none';?>" >
  <ul class="form-elements">
    <li class="to-label">
      <label><?php _e('Text Align','backend')?></label>
    </li>
    <li class="to-field">
      <div class="input-sec">
        <div class="select-style">
...
<div id="subheader_custom_slider" <?php if(isset($header_banner_style) && $header_banner_style != '' && $header_banner_style == "custom_slider"){echo 'style="display:block"';} else {echo 'style="display:none"';} ?> >
  ...
  <ul class="form-elements">
    ...
    <li class="to-field">
      ...
      <div class="left-info">
        <p>Please select Revolution Slider if already included in package. Otherwise buy Sliders from <a href="<?php _e('http://codecanyon.net/','backend');?>" target="_blank">Codecanyon</a>. But its optional</p>
      </div>
    </li>
  </ul>
  <ul class="form-elements">
...
function cs_pagebuilder_themeoptions(){
    ...
    <ul class="form-elements">
      <li class="to-label">
        <label> <?php _e('Page Options','backend'); ?> </label>
      </li>
      <li class="to-field">
        <div class="input-sec">
          <div class="select-style">
