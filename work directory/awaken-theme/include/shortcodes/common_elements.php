      ...
      <div class="cs-wrapp-clone cs-shortcode-wrapp cs-pbwp-content">
        <ul class="form-elements">
          ...
          <li class="to-field select-style">
            <select class="button_size" id="button_size" name="button_size[]">
            	<option value="btn-xlg" <?php if($button_size == 'btn-xlg'){echo 'selected="selected"';}?>>Extra Large </option>
                <option value="btn-lg" <?php if($button_size == 'btn-lg'){echo 'selected="selected"';}?>>Large </option>
                <option  value="medium-btn" <?php if($button_size == 'defualt medium-btn'){echo 'selected="selected"';}?>>Medium</option>
                <option value="btn-sml" <?php if($button_size == 'btn-sml'){echo 'selected="selected"';}?>>Small</option>
            </select>
            <div class='left-info'><p>Select column width. This width will be calculated depend page width</p>
          </li>
        </ul>
        <ul class="form-elements">
          <li class="to-label">
        ...
        <ul class="form-elements">
          ...
          <li class="to-field">
            ...
            <div class='left-info'><p>select a color which you want on the buttons</p>
          </li>
        </ul>
      ...
      <div class="cs-wrapp-clone cs-shortcode-wrapp cs-pbwp-content">
          ...
          <ul class="form-elements">
            ...
            <li class="to-field select-style">
              <select class="counter_icon_size" name="counter_icon_size[]">
                ...
                <option value="fa-2x" <?php if($counter_icon_size == 'fa-2x'){echo 'selected="selected"';}?>>Small</option>
                <option value="fa-3x" <?php if($counter_icon_size == 'fa-3x'){echo 'selected="selected"';}?>>Medium</option>
                <option value="fa-4x" <?php if($counter_icon_size == 'fa-4x'){echo 'selected="selected"';}?>>Large</option>
                <option value="fa-5x" <?php if($counter_icon_size == 'fa-5x'){echo 'selected="selected"';}?>>Extra Large</option>
              </select>
        ...
        <ul class="form-elements">
          ...
          <li class="to-field">
            ...
            <div class='left-info'><p>Use this option if you want to use specified id for this element</p>
          </li>
        </ul>
        <ul class="form-elements">
          <li class="to-label">
      ...
      <div class="cs-wrapp-tab-box">
       ...
       <?php
        ...
        <div class="wrapptabbox" style="padding:0">
          <div class="opt-conts">
            <ul class="form-elements noborder">
              <li class="to-field"> <a href="#" class="add_servicesss cs-main-btn" onclick="cs_shortcode_element_ajax_call('progressbars', 'shortcode-item-<?php echo esc_js($cs_counter);?>', '<?php echo esc_js(admin_url('admin-ajax.php'));?>')"><i class="fa fa-plus-circle"></i>Add Progressbar</a> </li>
               <div id="loading" class="shortcodeload"></div>
            </ul>
            <?php if(isset($_POST['shortcode_element']) && $_POST['shortcode_element'] == 'shortcode'){?>
            <ul class="form-elements insert-bg">
        ...
        <ul class="form-elements"  id="modern-size-<?php echo esc_attr($rand_counter);?>" style=" <?php echo esc_attr($cs_service_type) == '' || $cs_service_type == 'modern'? 'display:block;' : 'display:none;' ;?>">
          ...
          <li class="to-field select-style">
            <select class="service_icon_size" name="service_icon_size[]">
              <option value="fa-2x" <?php if($service_icon_size == 'fa-2x'){echo 'selected="selected"';}?>>Small</option>
              <option value="fa-3x" <?php if($service_icon_size == 'fa-3x'){echo 'selected="selected"';}?>>Medium</option>
              <option value="fa-4x" <?php if($service_icon_size == 'fa-4x'){echo 'selected="selected"';}?>>Large</option>
              <option value="fa-5x" <?php if($service_icon_size == 'fa-5x'){echo 'selected="selected"';}?>>Extra Large</option>
            </select>
            <div class='left-info'><p>Select Icon Size.</p></div>
          </li>
        </ul>
      ...
      <div class="cs-clone-append cs-pbwp-content">
       <div class="cs-wrapp-tab-box">
        <div id="shortcode-item-<?php echo esc_attr($cs_counter);?>" data-shortcode-template="{{child_shortcode}}[/cs_faq]" data-shortcode-child-template="[faq_item {{attributes}}] {{content}} [/faq_item]">
          ...
          <div class='cs-wrapp-clone cs-shortcode-wrapp  cs-pbwp-content'  id="cs_infobox_<?php echo esc_attr($rand_id);?>">
            <header>
              <h4><i class='fa fa-arrows'></i>FAQ</h4>
