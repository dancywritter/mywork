       ...
       <div class="cs-wrapp-tab-box">
        <div id="shortcode-item-<?php echo esc_attr($cs_counter);?>" data-shortcode-template="{{child_shortcode}} [/cs_infobox]" data-shortcode-child-template="[infobox_item {{attributes}}] {{content}} [/infobox_item]">
          ...
          <div class='cs-wrapp-clone cs-shortcode-wrapp'  id="cs_infobox_<?php echo cs_allow_special_char($rand_id);?>">
            <header>
              <h4><i class='fa fa-arrows'></i>Infobox Item(s)</h4>
              <a href='#' class='deleteit_node'><i class='fa fa-minus-circle'></i>Remove</a></header>
            <ul class='form-elements'>
              <li class='to-label'>
                <label>Info Box Fontawsome Icon:</label>
              </li>
             <li class="to-field">
        ...
        <ul class="form-elements">
          ...
          <li class="to-field select-style">
            <select class="icon_view" id="icon_view" name="icon_view[]" onchange="cs_icon_toggle_view(this.value,'<?php echo esc_attr($rand_counter);?>', jQuery(this))">
              <option <?php if($icon_view == 'bg_style'){echo 'selected="selected"';}?> value="bg_style">Background Style</option>
              <option <?php if($icon_view == 'border_style'){echo 'selected="selected"';}?> value="border_style">Border Style</option>
            </select>
          </li>
        </ul>
        ...
        <ul class="form-elements">
          ...
          <li class="to-field select-style">
            <select class="font_type" id="font_type" name="font_type[]">
              <option <?php if($font_type == 'circle'){echo 'selected="selected"';}?> value="circle">Circle</option>
              <option <?php if($font_type == 'square'){echo 'selected="selected"';}?> value="square">Square</option>
            </select>
          </li>
        </ul>
        <ul class="form-elements">
        ...
        <ul class="form-elements">
          ...
          <li class="to-field select-style">
            <select class="dropdown" name="map_border[]">
              <option <?php if($map_border == 'yes'){echo 'selected="selected"';}?> value="yes">Yes</option>
              <option <?php if($map_border == 'no'){echo 'selected="selected"';}?> value="no">No</option>
            </select>
