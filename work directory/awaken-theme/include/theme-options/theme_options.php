			...
			<div class="inner">
				...
				<div class="outerwrapp-layer">
					...
					<div class="loading_div">
						...
						<?php esc_html_e('Saving changes...','backend');?>
...
$mc_list = '';
	...
	$options[] = array( "name" => "Events Time Format",

						"desc" => "",

						"hint_text" => "Select the time format for events",
	...
	$options[] = array( "name" => "Header Styles",
						...
						"hint_text" => "Choose header style from the given options",
	...
	$options[] = array( "name" => "Login Options",
	...
	$options[] = array( "name" => "Tagline Text",
						...
						"hint_text" => "Enable/Disable Header Tagline Text",
	...
	$options[] = array( "name" => "Contribute Now",

						"desc" => "",

						"hint_text" => "Enable/Disable Contribute Now Button",
	...
	$options[] = array( "name" => "Contribute Now Button link",

						"desc" => "",

						"hint_text" => "Enter the Contribute Now Button Link",
	...
	$options[] = array( "name" => "NewsLetter Signup",
	...
	$options[] = array( "name" => "Footer Twitter Background Color",

						"desc" => "",

						"hint_text" => "Set Footer Twitter Background Color",
	...
	$options[] = array( "name" => "footer twitter",

						"desc" => "",

						"hint_text" => "set footer twitter on/off",
	...
	$options[] = array( 
					...
					"hint_text" => "set footer twitter username",
	...
	$options[] = array( 
					...
					"name" => "twitter no. of tweets",

					"desc" => "",

					"hint_text" => "set number of tweets such as 5",
	...
	$options[] = array( "name" => "Footer Widget Background Color",
	...
	$options[] = array( "name" => "Show Twitter",
...

	{
		...
		$options[] = array( "name" => "Facebook Login On/Off",
		...
		$options[] = array( "name" => "Facebook  Secret",
	...
	$options[] = array( "name" => "Google+ Login On/Off",
	...
	$options[] = array( "name" => "Google+ Client ID",
	...
	$options[] = array( "name" => "Google+ Client Secret",
	...
	$options[] = array( "name" => "Fixed redirect url for login",
