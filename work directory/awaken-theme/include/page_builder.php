		...
		<div class="tabs vertical">
        	<nav class="admin-navigtion">
               <ul id="myTab" class="nav nav-tabs">
                 <li class="active"><a href="#tab-general-settings" data-toggle="tab"><i class="fa fa-gear"></i> General Settings</a></li>
                 <li><a href="#tab-slideshow" data-toggle="tab"><i class="fa fa-forward"></i> Subheader</a></li>
                ...
                <?php if($cs_header_position == 'absolute'){?>
                 <li><a href="#tab-header-position-settings" data-toggle="tab"><i class="fa fa-forward"></i>Header Absolute</a></li>
                 <?php }?>
