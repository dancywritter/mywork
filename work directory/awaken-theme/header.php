...
<html <?php language_attributes(); ?>>
    ...
    <?php flush(); ?>
	<body <?php body_class();  if($cs_site_layout !='full_width'){ if ( function_exists( 'cs_bg_image' ) ) { echo cs_bg_image(); } } ?>  <?php if(isset($cs_theme_options['cs_smooth_scroll']) and $cs_theme_options['cs_smooth_scroll'] == 'on'){ ?>style="overflow: hidden;"<?php } ?>>
