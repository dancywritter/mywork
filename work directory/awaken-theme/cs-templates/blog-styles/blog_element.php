                ...
                <div class="input-sec">
                  <div class="select-style">
				    <select name="cs_blog_view[]" class="dropdown">
                      <option value="blog-small" <?php if($cs_blog_view == 'blog-small'){echo 'selected="selected"';}?>>Blog Small</option>
                      <option value="blog-medium" <?php if($cs_blog_view == 'blog-medium'){echo 'selected="selected"';}?>>Blog Medium</option>
                      <option value="blog-lrg" <?php if($cs_blog_view == 'blog-lrg'){echo 'selected="selected"';}?>>Blog Large</option>
                      <option value="blog-classic" <?php if($cs_blog_view == 'blog-classic'){echo 'selected="selected"';}?>>Blog Classic</option>
                      <option value="blog-timeline" <?php if($cs_blog_view == 'blog-timeline'){echo 'selected="selected"';}?>>Blog timeline</option>
                      <option value="blog-3-column" <?php if($cs_blog_view == 'blog-3-column'){echo 'selected="selected"';}?>>Blog 3 Column</option>
                      <option value="blog-grid" <?php if($cs_blog_view == 'blog-grid'){echo 'selected="selected"';}?>>Blog Grid</option>
                      <option value="blog-clean" <?php if($cs_blog_view == 'blog-clean'){echo 'selected="selected"';}?>>Blog Clean</option>
                      <option value="blog-box" <?php if($cs_blog_view == 'blog-box'){echo 'selected="selected"';}?>>Blog Box</option>
                      <option value="blog-elite" <?php if($cs_blog_view == 'blog-elite'){echo 'selected="selected"';}?>>Blog Elite</option>
                    </select>
                  </div>
                </div>
                <div class="left-info">
