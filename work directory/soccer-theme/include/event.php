	...
	function px_event_meta_data($post) {
		...
		if ( $px_event_meta <> "" ) {
			$px_xmlObject = new SimpleXMLElement($px_event_meta);
				...
				$event_result=$px_xmlObject->event_result;
				$var_pb_event_team1=$px_xmlObject->var_pb_event_team1;
				$var_pb_event_team2=$px_xmlObject->var_pb_event_team2;
    	...
    	<div class="page-wrap  event-meta-section">
            <div class="option-sec" style="margin-bottom:0;">
                ...
                <div class="opt-conts">
                    ...
                    <ul class="form-elements noborder">
                        <li class="to-field">
                            <input type="text" id="event_result" name="event_result" value="<?php echo $event_result;?>" />
                            <p>Fixture Result.</p>
                        </li>
                    </ul>
                    <ul class="form-elements noborder">
                        <li class="to-field">
                            <textarea type="text" id="event_summary" name="event_summary" cols="20" rows="20"> <?php echo $event_summary;?></textarea>
                            <p>Fixture Summary.</p>
                        </li>
                    </ul>
                    <div class="opt-head">
