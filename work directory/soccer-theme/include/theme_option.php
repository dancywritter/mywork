              ...
              <ul class="form-elements  noborder">
                    ...
                    <li class="to-field">
                        <select name="varto_bg_option" class="dropdown"  onchange="javascript:px_toggle_bg_options(this.value)">
                        	...
                        	<option <?php if($varto_bg_option=='custom-background-image') echo "selected";?> value="custom-background-image">Background Image</option>
                             <option value="background_video" <?php if($varto_bg_option=='background_video')echo "selected";?> >Video</option>
                        </select>
		...
		<ul class="form-elements">
          ...
          <div id="tab-footer-setting" style="display:none;">
            ...
            <ul class="form-elements">
              ...
              <li class="to-field">
                <input type="text" name="twitter_name" value="<?php echo $px_theme_option['twitter_name']?>" />
              </li>
               <li class="to-label">
                <label>No. of Tweets</label>
              </li>
              <li class="to-field">
                <input type="text" name="tweets_number" value="<?php echo $px_theme_option['tweets_number']?>" />
              </li>
            </ul>
