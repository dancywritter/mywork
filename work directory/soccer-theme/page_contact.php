            ...
            <div id="form_hide<?php echo $px_counter_node;?>">
                ...
                ?>" novalidate>   
                	...
                	<p class="comment-form-author">
                        ...
                        <input type="text" name="contact_name" id="contact_name" class="nameinput {validate:{required:true}}"   value="<?php _e('Name', 'Soccer Club'); ?>" />                        
                    ...
                    <p class="comment-form-email">
                        ...
                        <input type="text" name="contact_email" id="contact_email" class="emailinput {validate:{required:true ,email:true}}"   value="<?php _e('Email', 'Soccer Club'); ?>" />
                        <span>(<?php _e('required', 'TheSoccerClub');?>)</span>
                    </p>
                    <p class="comment-form-contact">
                        ...
                        <input type="text" name="subject" id="subject" class="subjectinput {validate:{required:true}}"   value="<?php if($px_theme_option['trans_switcher']== "on"){ _e('Subject','Soccer Club');}else{ echo $px_theme_option['trans_subject']; } ?>" />
                    </p>
                    ...
                    <p class="form-submit">
                        ...
                        <input type="submit" value="<?php _e('Submit', 'Soccer Club'); ?>" id="submit_btn<?php echo $px_counter_node ?>" class="backcolr">
						<span><?php if($px_theme_option['trans_switcher'] == "on"){ _e('*Your Email will never published.','Soccer Club');}else{ echo $px_theme_option['trans_email_published']; } ?></span>
                      </p>
