            ...
            <div class="page-head">
                ...
                <div class="add-widget">
                    ...
                    <div class="widgets-list">
                        ...
                        <a href="javascript:ajaxSubmit('cs_pb_now_playing')">Now Playing</a>
				...
				if ( $cs_page_bulider <> "" ) {
					...
					$cs_xmlObject = new SimpleXMLElement($cs_page_bulider);
                        ...
                        foreach ( $cs_xmlObject->children() as $cs_node ){
							...
							else if ( $cs_node->getName() == "now_playing" ) { cs_pb_now_playing(1); }
            ...
            <div class="elementhidden">
				...
				<ul class="form-elements noborder">
                    ...
                    <ul class="form-elements" id="layer_slider" style="display:<?php if($header_banner_options == "Slider")echo "inline"; else echo "none"; ?>" >
                        ...
                        <li class="to-label"></li>
                        <li class="to-field">
                            <p>Please enter the Revolution/Other Slider Short Code like [rev_slider rocky]</p>
                        </li>                                            
                    </ul>
                     <ul class="form-elements">
 								...
 								foreach ( $_POST['cs_orderby'] as $count ){
									if ( $_POST['cs_orderby'][$counter] == "gallery" ) {
										$gallery = $sxe->addChild('gallery');
											...
											$gallery->addChild('view_all', $_POST['cs_gal_view_all'][$counter_gal] );
											$gallery->addChild('view_all_url', $_POST['cs_gal_view_all_url'][$counter_gal] );
 									...
 									else if ( $_POST['cs_orderby'][$counter] == "now_playing" ) {
										$album = $sxe->addChild('now_playing');
											$album->addChild('now_playing_title', htmlspecialchars($_POST['now_playing_title'][$counter_now_playing]) );
											$album->addChild('now_playing_album', $_POST['now_playing_album'][$counter_now_playing] );
											$album->addChild('now_playing_tracks', $_POST['now_playing_tracks'][$counter_now_playing] );
											$album->addChild('now_playing_autoplay', $_POST['now_playing_autoplay'][$counter_now_playing] );
 											$album->addChild('now_playing_element_size', $_POST['now_playing_element_size'][$counter_now_playing] );
										$counter_now_playing++;
									}
										...
										$blog = $sxe->addChild('blog');
											...
											$blog->addChild('cs_blog_view_all', htmlspecialchars($_POST['cs_blog_view_all'][$counter_blog]) );
											$blog->addChild('cs_blog_view_all_url', htmlspecialchars($_POST['cs_blog_view_all_url'][$counter_blog]) );
									...
									else if ( $_POST['cs_orderby'][$counter] == "client" ) {
										$client = $sxe->addChild('client');
											$client->addChild('client_header_title', $_POST['client_header_title'][$counter_client] );
											$client->addChild('client_gallery', $_POST['client_gallery'][$counter_client] );
											$client->addChild('client_view', $_POST['client_view'][$counter_client] );
											$client->addChild('client_element_size', $_POST['client_element_size'][$counter_client] );
										$counter_client++;
									}
									...
									else if ( $_POST['cs_orderby'][$counter] == "services" ) {
										$services = $sxe->addChild('services');
											$services->addChild('services_element_size', htmlspecialchars($_POST['services_element_size'][$counter_services]) );
											for ( $i = 1; $i <= $_POST['services_num'][$counter_services]; $i++ ){
												$service = $services->addChild('service');
												$service->addChild('service_title', htmlspecialchars( $_POST['service_title'][$counter_services_node] ) );
												$service->addChild('service_icon', htmlspecialchars( $_POST['service_icon'][$counter_services_node] ) );
												$service->addChild('service_url', htmlspecialchars( $_POST['service_url'][$counter_services_node] ) );
												$service->addChild('service_text', htmlspecialchars( $_POST['service_text'][$counter_services_node] ) );
												$service->addChild('service_style', htmlspecialchars( $_POST['service_style'][$counter_services_node] ) );
												$counter_services_node++;
											}
										$counter_services++;
									}
									...
									else if ( $_POST['cs_orderby'][$counter] == "parallax" ) {
										$parallax = $sxe->addChild('parallax');
											$parallax->addChild('parallax_element_size', $_POST['parallax_element_size'][$counter_parallax] );
											$parallax->addChild('parallax_view', $_POST['parallax_view'][$counter_parallax] );
											$parallax->addChild('parallax_height', $_POST['parallax_height'][$counter_parallax] );
											$parallax->addChild('parallax_margin_top', $_POST['parallax_margin_top'][$counter_parallax] );
											$parallax->addChild('parallax_margin_bottom', $_POST['parallax_margin_bottom'][$counter_parallax] );
											$parallax->addChild('parallax_element', htmlspecialchars($_POST['parallax_element'][$counter_parallax]) );
											$parallax->addChild('parallax_back_top', htmlspecialchars($_POST['parallax_back_top'][$counter_parallax]) );
											
											$parallax->addChild('parallax_twitter_profile', htmlspecialchars($_POST['parallax_twitter_profile'][$counter_parallax]) );						$parallax->addChild('parallax_twitter_num_tweets', htmlspecialchars($_POST['parallax_twitter_num_tweets'][$counter_parallax]) );
											$parallax->addChild('parallax_twitter_bgimg', htmlspecialchars($_POST['parallax_twitter_bgimg'][$counter_parallax]) );											$parallax->addChild('parallax_twitter_bgcolor', htmlspecialchars($_POST['parallax_twitter_bgcolor'][$counter_parallax]) );
											$parallax->addChild('parallax_map_title', htmlspecialchars($_POST['parallax_map_title'][$counter_parallax]) );
											$parallax->addChild('parallax_map_lat', htmlspecialchars($_POST['parallax_map_lat'][$counter_parallax]) );
											$parallax->addChild('parallax_map_lon', htmlspecialchars($_POST['parallax_map_lon'][$counter_parallax]) );
											$parallax->addChild('parallax_map_zoom', htmlspecialchars($_POST['parallax_map_zoom'][$counter_parallax]) );
											$parallax->addChild('parallax_map_type', htmlspecialchars($_POST['parallax_map_type'][$counter_parallax]) );
											$parallax->addChild('parallax_map_info', $_POST['parallax_map_info'][$counter_parallax] );
											$parallax->addChild('parallax_map_info_width', $_POST['parallax_map_info_width'][$counter_parallax] );
											$parallax->addChild('parallax_map_info_height', $_POST['parallax_map_info_height'][$counter_parallax] );
											$parallax->addChild('parallax_map_marker_icon', $_POST['parallax_map_marker_icon'][$counter_parallax] );
											$parallax->addChild('parallax_map_show_marker', $_POST['parallax_map_show_marker'][$counter_parallax] );
											$parallax->addChild('parallax_map_controls', $_POST['parallax_map_controls'][$counter_parallax] );
											$parallax->addChild('parallax_map_draggable', htmlspecialchars($_POST['parallax_map_draggable'][$counter_parallax]) );
											$parallax->addChild('parallax_map_scrollwheel', htmlspecialchars($_POST['parallax_map_scrollwheel'][$counter_parallax]) );
											//$parallax->addChild('parallax_map_view', htmlspecialchars($_POST['map_view'][$counter_parallax]) );
											$parallax->addChild('parallax_map_bgcolor', htmlspecialchars($_POST['parallax_map_bgcolor'][$counter_parallax]) );
											$parallax->addChild('parallax_custom_text', htmlspecialchars($_POST['parallax_custom_text'][$counter_parallax]) );
											$parallax->addChild('parallax_custom_img', htmlspecialchars($_POST['parallax_custom_img'][$counter_parallax]) );
											$parallax->addChild('parallax_custom_bgcolor', htmlspecialchars($_POST['parallax_custom_bgcolor'][$counter_parallax]) );										$parallax->addChild('parallax_album', $_POST['parallax_album'][$counter_parallax] );
											$parallax->addChild('parallax_album_bgcolor', $_POST['parallax_album_bgcolor'][$counter_parallax] );
											$parallax->addChild('parallax_album_autoplay', $_POST['parallax_album_autoplay'][$counter_parallax] );
											$parallax->addChild('parallax_photo_album_bgcolor', $_POST['parallax_photo_album_bgcolor'][$counter_parallax] );
											$parallax->addChild('parallax_photo_album_title', $_POST['parallax_photo_album_title'][$counter_parallax] );
											$parallax->addChild('parallax_photo_album_post_per_page', $_POST['parallax_photo_album_post_per_page'][$counter_parallax] );
											$parallax->addChild('parallax_gallery', $_POST['parallax_gallery'][$counter_parallax] );
											$parallax->addChild('parallax_gallery_title', $_POST['parallax_gallery_title'][$counter_parallax] );
										$counter_parallax++;
									}
									$counter++;
								}
