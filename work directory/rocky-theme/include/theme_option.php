...
function theme_option() {
	global $post, $header1_default_colors, $header2_default_colors, $header3_default_colors, $header4_default_colors, $header5_default_colors;
      ...
      <div class="row"> 
        ...
        <div class="col1">
          ...
          <div class="arrowlistmenu" id="paginate-slider2">
            ...
            <ul class="categoryitems">
              ...
              <li class="tab-head-styles"><a href="#tab-head-styles" onClick="toggleDiv(this.hash);return false;">Header Setting</a></li>
            </ul>
					...
					<div id="tab-logo" style="display:none;">
                                    ...
                                    <div class="theme-help">
                                        ...
                                        <ul class="form-elements">
                                            ...
                                            <li class="to-field">
                                                <input id="main_logo" name="main_logo" value="<?php echo $cs_theme_option['main_logo']?>" type="text" class="small {validate:{accept:'jpg|jpeg|gif|png|bmp'}}" />
                                                <input id="main_logo" name="main_logo" type="button" class="uploadfile left" value="Browse"/>
                                                <?php if ( $cs_theme_option['main_logo'] <> "" ) { ?>
                                                    <div class="thumb-preview" id="main_logo_img_div">
                                                        <img width="<?php echo $cs_theme_option['main_logo_width']?>" height="<?php echo $cs_theme_option['main_logo_height']?>" src="<?php echo $cs_theme_option['main_logo']?>" />
                                        ...
                                        <ul class="form-elements">
                                            ...
                                            <li class="to-field">
                                                <input type="text" name="main_logo_width" id="width-value" value="<?php echo $cs_theme_option['main_logo_width']?>" class="vsmall" />
                                        ...
                                        <ul class="form-elements">
                                            ...
                                            <li class="to-field">
                                                <input type="text" name="main_logo_height" id="height-value" value="<?php echo $cs_theme_option['main_logo_height']?>" class="vsmall" />
                                                <span class="short">px</span><p>Please enter the required size.</p>
                                            </li>
                                        </ul>
                                        <ul class="form-elements">
          ...
          <div id="tab-head-styles" style="display:none;">
            ...
            <div class="header-section" id="header_banner1" style="display: <?php echo $display; ?>;" >
              ...
              <ul class="form-elements">
                ...
                <li class="to-field">
                  <input type="text" name="header_1_bgcolor" value="<?php echo $cs_theme_option['header_1_bgcolor'] ?>" class="bg_color" data-default-color="<?php echo $header1_default_colors['header_1_bgcolor']; ?>" />
                </li>
              </ul>
              ...
              <div class="opt-head">
				...
				<ul class="form-elements">
                    ...
                    <li class="to-field">
                      <input type="hidden" name="header_1_strip" value="" data-default-header="<?php echo $header1_default_colors['header_1_strip']; ?>"/>
                      <input type="checkbox" class="myClass" name="header_1_strip" <?php if ($cs_theme_option['header_1_strip'] == "on") echo "checked" ?> />
                    </li>
                    <li class="full">&nbsp;</li>
                    <li class="to-label">
                      <label>Social Icon on/off</label>
                    </li>
                    <li class="to-field">
                      <input type="hidden" name="header_1_social" value="" data-default-header="<?php echo $header1_default_colors['header_1_social']; ?>"/>
                      <input type="checkbox" class="myClass" name="header_1_social" <?php if ($cs_theme_option['header_1_social'] == "on") echo "checked" ?> />
                    </li>
                    <li class="full">&nbsp;</li>
                    <li class="to-label">
                      <label>Login on/off</label>
                    </li>
                    <li class="to-field">
                      <input type="hidden" name="header_1_login" value="" data-default-header="<?php echo $header1_default_colors['header_1_login']; ?>"/>
                      <input type="checkbox" class="myClass" name="header_1_login" <?php if ($cs_theme_option['header_1_login'] == "on") echo "checked" ?> />
                    </li>
                    <li class="full">&nbsp;</li>
                    <li class="to-label">
                    ...
                    <li class="to-field">
                      <textarea rows="2" cols="4" name="header_1_top_strip_right_area_text" data-default-header="<?php echo $header1_default_colors['header_1_top_strip_right_area_text']; ?>"><?php echo $cs_theme_option['header_1_top_strip_right_area_text'] ?></textarea>
                    </li>
                    <li class="full">&nbsp;</li>
                    <li class="to-label">
                    ...
                    <li class="to-field">
                      <input type="text" name="header_1_top_strip_bg_color" value="<?php echo $cs_theme_option['header_1_top_strip_bg_color'] ?>" class="bg_color" data-default-color="<?php echo $header1_default_colors['header_1_top_strip_bg_color']; ?>" />
                    </li>
                    <li class="full">&nbsp;</li>
                    <li class="to-label">
                    ...
                    <li class="to-field">
                      <input type="text" name="header_1_top_strip_color" value="<?php echo $cs_theme_option['header_1_top_strip_color'] ?>" class="bg_color" data-default-color="<?php echo $header1_default_colors['header_1_top_strip_color']; ?>" />
                    </li>
                    <li class="full">&nbsp;</li>
              </ul>
            ...
            <div class="header-section" id="header_banner2" style=" <?php
              ...
              <div class="opt-head">
				...
				<ul class="form-elements">
                    ...
                    <li class="to-field">
                      <input type="hidden" name="header_2_social" value="" data-default-header="<?php echo $header2_default_colors['header_2_social']; ?>"/>
                      <input type="checkbox" class="myClass" name="header_2_social" <?php if ($cs_theme_option['header_2_social'] == "on") echo "checked" ?> />
                    </li>
                    <li class="full">&nbsp;</li>
                    <li class="to-label">
                      <label>Login on/off</label>
                    ...
                    <li class="to-field">
                      <input type="hidden" name="header_2_login" value="" data-default-header="<?php echo $header2_default_colors['header_2_login']; ?>"/>
                      <input type="checkbox" class="myClass" name="header_2_login" <?php if ($cs_theme_option['header_2_login'] == "on") echo "checked" ?> />
                    </li>
                    <li class="full">&nbsp;</li>
                    <li class="to-label">
                      <label>Strip Menu</label>
                    ...
                    <li class="to-field">
                      <?php
                                     $menus = get_nav_menu_locations();
                                     ?>
                      <select name="header_2_top_strip_menu" data-default-header="<?php echo $header2_default_colors['header_2_top_strip_menu']; ?>">
                        <option value="">Select Menu</option>
                        <?php
                                        foreach ($menus as $key => $value) {
                                           ?>
                        <option value="<?php echo $key; ?>" <?php if ($cs_theme_option['header_2_top_strip_menu'] == $key) echo "selected='selected'" ?>><?php echo $key; ?></option>
                        <?php } ?>
                      </select>
                    </li>
                    <li class="full">&nbsp;</li>
                    ...
                    <li class="to-field">
                      <textarea rows="2" cols="4" name="header_2_top_strip_right_area_text" data-default-header="<?php echo $header2_default_colors['header_2_top_strip_right_area_text']; ?>"><?php echo $cs_theme_option['header_2_top_strip_right_area_text'] ?></textarea>
                    </li>
                    <li class="full">&nbsp;</li>
                    <li class="to-label">
                      <label>Strip bgcolor</label>
                    ...
                    <li class="to-field">
                      <input type="text" name="header_2_top_strip_bg_color" value="<?php echo $cs_theme_option['header_2_top_strip_bg_color'] ?>" class="bg_color" data-default-color="<?php echo $header2_default_colors['header_2_top_strip_bg_color']; ?>" />
                    </li>
                    <li class="full">&nbsp;</li>
                    <li class="to-label">
                      <label>Strip Text Color</label>
                    ...
                    <li class="to-field">
                      <input type="text" name="header_2_top_strip_color" value="<?php echo $cs_theme_option['header_2_top_strip_color'] ?>" class="bg_color" data-default-color="<?php echo $header2_default_colors['header_2_top_strip_color']; ?>" />
                    </li>
                    <li class="full">&nbsp;</li>
              </ul>
            ...
            <div class="header-section" id="header_banner4" style=" <?php
              ...
              <ul class="form-elements">
                ...
                <li class="to-field">
                  <input type="text" name="header_4_nav_hover_color" value="<?php echo $cs_theme_option['header_4_nav_hover_color'] ?>" class="bg_color" data-default-color="<?php echo $header4_default_colors['header_4_nav_hover_color']; ?>" />
                </li>
            ...
            <div id="header_banner5" style=" <?php
              ...
              <div class="opt-head">
				...
				<ul class="form-elements">
                    ...
                    <li class="to-field">
                        <input id="header_5_adv" name="header_5_adv" value="<?php echo $cs_theme_option['header_5_adv']?>" type="text" class="small {validate:{accept:'jpg|jpeg|gif|png|bmp'}}" />
                        <input id="header_5_adv" name="header_5_adv" type="button" class="uploadfile left" value="Browse"/>
                    </li>
                    <li class="full">&nbsp;</li>
                    <li class="to-label">
                    ...
                    <li class="to-field">
                        <input name="header_5_adv_link" type="text" value="<?php echo $cs_theme_option['header_5_adv_link']?>" />
                    </li>
				</ul>
        ...
        <div id="tab-foot-setting" style="display:none;">
          ...
          <ul class="form-elements">
            ...
            <li class="to-field">
              <input type="text" name="powered_by" value="<?php echo $cs_theme_option['powered_by']?>" />
              <p>Please enter powered by text.</p>
            </li>
          </ul>
          <ul class="form-elements">
                <li class="to-label"><label>Footer Background Color</label></li>
                <li><input type="text" name="footer_bg_color" value="<?php echo $cs_theme_option['footer_bg_color']?>" class="bg_color"  /></li>
          </ul>
          <ul class="form-elements">    
                <li class="to-label"><label>Footer Text Color</label></li>
                <li><input type="text" name="footer_text_color" value="<?php echo $cs_theme_option['footer_text_color']?>" class="bg_color"  /></li>
          </ul>
          <ul class="form-elements">
               	<li class="to-label"><label>Copyright Background Color</label></li>
                <li><input type="text" name="copyright_bg_color" value="<?php echo $cs_theme_option['copyright_bg_color']?>" class="bg_color"  /></li>
          </ul>
          <ul class="form-elements">
            <li class="to-label">
        ...
        <div id="tab-slider" style="display:none;">
          ...
          <ul class="form-elements">
            ...
            <li class="to-field">
              <select name="slider_type" class="dropdown" onchange="javascript:home_slider_toggle(this.value)">
                ...
                <option <?php if($cs_theme_option['slider_type']=="Revolution Slider"){echo "selected";}?> >Revolution Slider</option>
              </select>
            </li>
          </ul>
          ...
          <ul class="form-elements" id="layer_slider" style=" <?php if($cs_theme_option['slider_type'] =="" or $cs_theme_option['slider_type'] <> "Revolution Slider")echo "display:none"; else "display:inline"; ?>" >
            <li class="to-label">
              <label>Revolution Slider Short Code</label>
            </li>
            <li class="to-field">
						...
						foreach ( $cs_theme_option['social_net_url'] as $val ){
							...
							echo '<tr id="del_'.$counter_social_network.'">';
								if(isset($cs_theme_option['social_net_awesome'][$i]) && $cs_theme_option['social_net_awesome'][$i] <> ''){
									echo '<td><i style="color: green;" class="fa '.$cs_theme_option['social_net_awesome'][$i].' fa-stack-2x"></td>';
								} else {
        ...
        <div id="tab-album-translation" style="display:none;">
          ...
          <ul class="form-elements">
            <li class="to-label"><label>Load More</label></li>
            <li class="to-field"><input type="text" name="trans_album_load_more" value="<?php echo $cs_theme_option['trans_album_load_more']?>" /></li>
          </ul>
		  <ul class="form-elements">
            <li class="to-label"><label>Play Now</label></li>
        ...
        <div id="tab-event-translation" style="display:none;">
          ...
          <ul class="form-elements">
            ...
            <li class="to-field">
              <input type="text" name="trans_event_time" value="<?php echo $cs_theme_option['trans_event_time']?>" />
            </li>
          </ul>
          <ul class="form-elements">
            <li class="to-label">
            ...
            <li class="to-field">
              <input type="text" name="trans_event_ticket_price" value="<?php echo $cs_theme_option['trans_event_ticket_price']?>" />
            </li>
          </ul>
          <ul class="form-elements">
            <li class="to-label">
          ...
          <ul class="form-elements">
            ...
            <li class="to-field">
              <input type="text" name="trans_event_time_left" value="<?php echo $cs_theme_option['trans_event_time_left']?>" />
            </li>
          </ul>
          <ul class="form-elements">
            <li class="to-label">
            ...
            <li class="to-field">
              <input type="text" name="trans_event_artist_title" value="<?php echo $cs_theme_option['trans_event_artist_title']?>" />
            </li>
          </ul>
		  <ul class="form-elements">
            <li class="to-label">
		  ...
		  <ul class="form-elements">
            ...
            <li class="to-field">
              <input type="text" name="trans_event_tickets" value="<?php echo $cs_theme_option['trans_event_tickets']?>" />
            </li>
          </ul>
        ...
        <div id="tab-other-translation" style="display:none;">
		  ...
		  <ul class="form-elements">
            ...
            <li class="to-field">
              <input type="text" name="trans_other_on" value="<?php echo $cs_theme_option['trans_other_on']?>" />
            </li>
          </ul>
		  ...
		  <ul class="form-elements">
            <li class="to-label">
              <label>View More Blogs</label>
            </li>
            <li class="to-field">
              <input type="text" name="trans_view_more_blogs" value="<?php echo $cs_theme_option['trans_view_more_blogs']?>" />
            </li>
          </ul>
        ...
        <div id="tab-import-export" style="display:none;">
          ...
          <!--<ul class="form-elements">
            ...
            <li class="to-field">
              <textarea id="theme_option_data" name="theme_option_data"><?php //echo base64_encode(serialize($cs_theme_option)); ?></textarea>
              <p>You can copy your current theme data in a text file and import it later by replacing the above text.</p>
              <p><input type="button" value="Import This Data" onclick="cs_to_import_export('<?php echo home_url()?>', '<?php echo get_template_directory_uri()?>')" /></p>
            </li>
          </ul>-->
        </div>
        <!-- import / export end -->
