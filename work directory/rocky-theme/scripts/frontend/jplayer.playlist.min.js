...
(function(b, f) {
	...
	jPlayerPlaylist.prototype = {
		...
		_createListItem: function(a) {
			...
			d += "<a href='javascript:;' class='" + this.options.playlistOptions.itemClass + "' tabindex='1'><em class='fa fa-play'></em><em class='fa fa-pause'></em><span class='title-song'>" + a.title + (a.artist ?
				"</span><span class='jp-artist'>" + a.artist + "</span>" : "") + (a.desc ?
				" <span class='jp-desc'><em class='fa fa-file-text-o'></em><div class='infosong'>" + a.desc + "</div></span>" : "") + "</a>";
			return d += "</div></li>"
		},
