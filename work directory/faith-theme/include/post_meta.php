            ...
            <div class="opt-conts">
            	<ul class="form-elements noborder">
                    ...
                    <li class="to-field">
                        ...
                        <ul class="form-elements" id="post_thumb_slider" style="display:<?php if($post_thumb_view=="Slider")echo 'inline"';else echo 'none';?>" >
                         ...
                         <ul class="form-elements" id="post_thumb_gallery" style="display:<?php if($post_thumb_view=="Gallery")echo 'inline"';else echo 'none';?>" >
                            ...
                            <li class="to-field">
                                ...
                                ?>
                                <option <?php if($post->ID==$post_thumb_gallery)echo "selected";?> value="<?php echo $post->ID; ?>"><?php the_title()?></option>
                        ...
                        <p>Gallery only work for blog large view.</p>
                ...
                <ul class="form-elements noborder">
                    ...
                    <li class="to-field">
                        ...
                        <ul class="form-elements" id="inside_post_thumb_gallery" style="display:<?php if($inside_post_thumb_view=="Gallery")echo 'inline"';else echo 'none';?>" >
                            <li class="to-label"><label>Select Gallery</label></li>
                            <li class="to-field">
                                ...
                                ?>
                              <option <?php if($post->ID==$inside_post_thumb_gallery)echo "selected";?> value="<?php echo $post->ID; ?>"><?php the_title()?></option>
