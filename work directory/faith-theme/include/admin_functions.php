...
function cs_pb_gallery($die = 0){
	...
	if ( isset($_POST['action']) ) {
		...
		$name = $cs_node->getName();
			...
			$cs_gal_gallery_db = $cs_node->gallery;
            ...
            <div class="opt-conts">
                ...
                <ul class="form-elements">
                    ...
                    <li class="to-field">
                        ...
                        <select name="cs_gal_gallery[]" class="dropdown">
                            ...
                            ?>
                                ...
                                <option <?php if($post->post_name==$cs_gal_gallery_db)echo "selected";?> value="<?php echo $post->post_name; ?>"><?php echo get_the_title()?></option>
...
function cs_pb_gallery_albums($die = 0){
	...
	if ( isset($_POST['action']) ) {
		...
		$name = $cs_node->getName();
			...
			$cs_gal_ablum_view = $cs_node->cs_gal_ablum_view;
        ...
        <div class="poped-up" id="<?php echo $name.$counter?>" style="border:none; background:#f8f8f8;" >
            ...
            <div class="opt-conts">
                ...
                <ul class="form-elements">
                        ...
                        <li class="to-field">
                            <select name="cs_gal_ablum_view[]" class="dropdown">
                                <option <?php if($cs_gal_ablum_view=="galleryablum-grid")echo "selected";?> value="galleryablum-grid">Grid</option>
                                <option <?php if($cs_gal_ablum_view=="galleryablum-slider")echo "selected";?> value="galleryablum-slider">Slider</option>
                             </select>
                        </li>                                        
                    </ul>
...
?> 
	<div id="<?php echo $name.$counter?>_del" class="column parentdelete column_<?php echo $prayer_element_size?>" item="prayer" data="<?php echo element_size_data_array_index($prayer_element_size)?>" >
    	<div class="column-in">
            <h5><?php echo ucfirst(str_replace("cs_pb_","",$name))?></h5>
...
function cs_pb_sermon($die = 0){
	...
	if ( isset($_POST['action']) ) {
		...
		$name = $cs_node->getName();
			$count_node++;
			$sermon_element_size = $cs_node->sermon_element_size;
			$sermon_cat = $cs_node->sermon_cat;
			$sermon_filterable = $cs_node->sermon_filterable;
			$sermon_pagination = $cs_node->sermon_pagination;
			$sermon_per_page = $cs_node->sermon_per_page;
				$counter = $post->ID.$count_node;
	}
?> 
	<div id="<?php echo $name.$counter?>_del" class="column parentdelete column_<?php echo $sermon_element_size?>" item="blog" data="<?php echo element_size_data_array_index($sermon_element_size)?>" >
		<div class="column-in">
            <h5><?php echo ucfirst(str_replace("cs_pb_","",$name))?></h5>
            <input type="hidden" name="sermon_element_size[]" class="item" value="<?php echo $sermon_element_size?>" >
            <a href="javascript:hide_all('<?php echo $name.$counter?>')" class="options">Options</a>
            <a href="#" class="delete-it btndeleteit">Del</a> &nbsp; 
            <a class="decrement" onclick="javascript:decrement(this)">Dec</a> &nbsp; 
            <a class="increment" onclick="javascript:increment(this)">Inc</a>
        ...
        <div class="poped-up" id="<?php echo $name.$counter?>" style="border:none; background:#f8f8f8;" >
            ...
            <div class="opt-conts">
                <ul class="form-elements">
                    ...
                    <li class="to-field">
                        <select name="sermon_cat[]" class="dropdown">
                        	<option value="0">-- Select Category --</option>
                        	<?php show_all_cats('', '', $sermon_cat, "sermon-category");?>
                        </select>
                        <p>Choose category to show the list</p>
                    </li>
                </ul>
                <ul class="form-elements">
                    <li class="to-label"><label>Filterable</label></li>
                    <li class="to-field">
                        <select name="sermon_filterable[]" class="dropdown" onchange="cs_toggle_tog('pagination<?php echo $name.$counter?>')">
                            <option <?php if($sermon_filterable=="Off")echo "selected";?> >Off</option>
                            <option <?php if($sermon_filterable=="On")echo "selected";?> >On</option>
                        </select>
                    </li>
                </ul>
                	<div id="pagination<?php echo $name.$counter?>" style=" <?php if($sermon_filterable=="On")echo 'display:none'; ?>" >
                        <ul class="form-elements">
                            <li class="to-label"><label>Pagination</label></li>
                            <li class="to-field">
                                <select name="sermon_pagination[]" class="dropdown" >
                                    <option <?php if($sermon_pagination=="Show Pagination")echo "selected";?> >Show Pagination</option>
                                    <option <?php if($sermon_pagination=="Single Page")echo "selected";?> >Single Page</option>
                                </select>
                            </li>
                        </ul>
                        <ul class="form-elements">
                            ...
                            <li class="to-field">
                                <input type="text" name="sermon_per_page[]" class="txtfield" value="<?php if($sermon_per_page=="")echo "5"; else echo $sermon_per_page;?>" />
                            </li>
                        </ul>
					</div>
                <ul class="form-elements noborder">
...
function cs_pb_event($die = 0){
	...
	if ( isset($_POST['action']) ) {
		...
		$cs_event_excerpt_db = '255';
		
		$cs_event_description_db = '';
		...
		$name = $cs_node->getName();
			...
			$cs_event_viewall_db = $cs_node->cs_event_viewall;
			
			$cs_event_excerpt_db = $cs_node->cs_event_excerpt;
			
			$cs_event_description_db = $cs_node->cs_event_description;
				...
				<ul class="form-elements">
                    ...
                    <li class="to-field">
                        ...
                        <select name="cs_event_view[]" class="dropdown">
                         	...
                         	<option <?php if($cs_event_view_db=="event-listing")echo "selected";?> value="event-listing">Listing View</option>
                         	<option <?php if($cs_event_view_db=="event-medium")echo "selected";?> value="event-medium">Medium View</option>
                 ...
                 <ul class="form-elements">
                    <li class="to-label"><label>View All URL</label></li>
                    <li class="to-field">
                        <input type="text" name="cs_event_viewall[]" class="txtfield" value="<?php echo $cs_event_viewall_db;?>" />
                        <p>Enter Event View URL</p>
                    </li>                         
                </ul>
                <ul class="form-elements">
                    <li class="to-label"><label>Event Description</label></li>
                    <li class="to-field">
                        <select name="cs_event_description[]" class="dropdown" >
                            <option <?php if($cs_event_description_db=="yes")echo "selected";?> value="yes">Yes</option>
                            <option <?php if($cs_event_description_db=="no")echo "selected";?> value="no">No</option>
                        </select>
                    </li>
                </ul>
                <ul class="form-elements">
...
function cs_pb_contact($die = 0){
	...
	if ( isset($_POST['action']) ) {
		...
		$name = $cs_node->getName();
			...
			$cs_form_title_db = $cs_node->cs_form_title;
            ...
            <div class="opt-conts">
				<ul class="form-elements">
                    ...
                    <li class="to-field">
                        ...
                        <input type="text" name="cs_form_title[]" class="txtfield" value="<?php echo $cs_form_title_db;?>" />

                        <p>Please enter form title.</p>
	...
	if ( isset($_POST['action']) ) {
		...
		$map_conactus_content = '<a href="'.home_url().'" class="logo"><img src="'.get_template_directory_uri().'/images/logo.png" alt=""></a>
                            ...
                            <ul>
                                ...
                                <li><span>Emailx</span><a class="cs-colrhvr" href="#">resturant@resturant.com</a></li>
        ...
        <ul class="form-elements meta-body" style=" <?php if($cs_sidebar_left == ""){echo "display:none";}else echo "display:block";?>" id="sidebar_left" >
            ...
            <li class="to-field">
                ...
                <select name="cs_sidebar_left" class="select_dropdown" id="page-option-choose-left-sidebar">
                     <option <?php if ($cs_sidebar_left=='sidebar-1')echo "selected";?> value="sidebar-1" >Primary Sidebar</option>
					<?php
...
function cs_pb_parallax($die = 0){
	...
	if ( isset($_POST['action']) ) {
		...
		$name = $cs_node->getName();
			...
			$parallax_event_title=$cs_node->parallax_event_title;
			$parallax_event_cat=$cs_node->parallax_event_cat;
			$parallax_event_img =$cs_node->parallax_event_img;
   			$counter = $post->ID.$count_node;
}
?> 
            	...
            	<ul class="form-elements">
                    ...
                    <li class="to-field">
                    	<select class="dropdown" name="parallax_element[]" onchange="parallax_element(this.value,<?php echo $counter; ?>)">
                            ...
                            <option <?php if($parallax_element=="event")echo 'selected';?> value="event">Upcoming Event</option>
                        </select>
                    </li>
                </ul>
                 ...
                 <div id="event_form<?php echo $counter;?>" <?php if($parallax_element<>"event")echo 'style="display:none"';?> >
                	<ul class="form-elements">
                        <li class="to-label"><label>Title</label></li>
                        <li class="to-field"><input type="text" name="parallax_event_title[]" value="<?php echo $parallax_event_title?>" /></li>
                    </ul>
                     <ul class="form-elements">
                        <li class="to-label"><label>Image Path</label></li>
                        <li class="to-field">
                            <input type="text" name="parallax_event_img[]" class="txtfield" value="<?php echo $parallax_event_img;?>" />
                            <p>e.g. http://yourdomain.com/logo.png</p>
                        </li>
                    </ul>
                    <ul class="form-elements">
                        <li class="to-label"><label>Select Category</label></li>
                        <li class="to-field">
                            <select name="parallax_event_cat[]" class="dropdown">
                               <option value="0">-- Select Category --</option>
                               <?php show_all_cats('', '', $parallax_event_cat, "event-category");?>
