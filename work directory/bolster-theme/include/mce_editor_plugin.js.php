                     ...
                     title : 'Shortcode',
                         onselect : function(v) { //Add shortcode data onClick
                             if(v == 'toogle'){
                                        ...
                                        tinyMCE.activeEditor.selection.setContent('[message_box type="info/warning" style="1-3" align="left" icon="icon-info-sign" close="yes" color="#COLOR_CODE" background="#COLOR_CODE" border_color="#COLOR_CODE" title="Message Title"]Message Content[/message_box]');
                                }
                             else if(v == 'frame'){
                                        ...
                                        tinyMCE.activeEditor.selection.setContent('[icon class="icon-twitter" type="rounded" size="icon-4x" border="no" bgcolor="#000" color="#ff0000"][/icon]');
                                }
                             else if(v == 'code'){
