...
?>
            ...
            <script type="text/javascript" src="<?php echo get_template_directory_uri()?>/scripts/admin/jquery.scrollTo-min.js"></script>
                <div class="option-sec" style="margin-bottom:0;">
                    <div class="opt-head">
                        <h4>Release Date and Social Sharing</h4>
                        <div class="clear"></div>
                    </div>
                    <div class="opt-conts">
                        ...
                        <ul class="form-elements">
                        	...
                        	<li class="to-field">
                            	<input type="text" id="cs_album_rating" name="cs_album_rating" value="<?php echo $cs_album_rating;?>" />
                                 <p>Enter Album Rating from 1 to 5</p>
                            </li>
                       </ul>
                    </div>
					<div class="clear"></div>
                ...
                <div class="option-sec row" style="margin-bottom:0;">
                    ...
                    <div class="opt-conts">
                        ...
                        <ul class="form-elements">
                            ...
                            <li class="to-field">
                            	<input type="text" name="album_buy_url" id="album_buy_url" value="<?php echo htmlspecialchars($album_buy_url)?>" />
                ...
                <div class="boxes tracklists">
                	<div id="add_track" class="poped-up">
                        ...
                        <ul class="form-elements noborder">
                            ...
                            <li class="to-field"><input type="button" value="Add Track to List" onclick="cs_add_track_to_list('<?php echo home_url()?>', '<?php echo get_template_directory_uri()?>')" /></li>
                        </ul>
                    </div>
                    <script>
			...
			{  
				$sxe = new SimpleXMLElement("<album></album>");
					...
					if ( empty($_POST["album_buy_cloud"]) ) $_POST["album_buy_cloud"] = "";
								...
								$sxe->addChild('album_buy_url', htmlspecialchars($_POST['album_buy_url']) );
							$counter = 0;
