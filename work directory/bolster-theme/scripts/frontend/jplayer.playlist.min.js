	...
	jPlayerPlaylist.prototype = {
		...
		_refresh: function(a) {
			...
			if (a && !b.isFunction(a)) b(this.cssSelector.playlist + " ul").empty(), b.each(this.playlist, function(a) {
				...
				jQuery(".album-playlist li") .hide().filter(':lt(7)').fadeIn(200);
			}), this._updateControls();
			else {
		...
		_createListItem: function(a) {
			var c =
				this,
				d = "<li class='bgcolrhovr'><div class='fullwidth'>",
			...
			d += "<a href='javascript:;' class='" + this.options.playlistOptions.itemClass + "' tabindex='1'><span class='jp-play-pause'><em class='fa fa-play'></em><em class='fa fa-pause'></em></span><span class='album-download-option'>" + a.title + (a.artist ?
				"</span><span class='jp-artist'>" + a.artist + "</span>":"")+"</a>";
				if (a.dwnload || a.amzstore || a.appstore || a.buylink || a.grvstore) {
				d += "<span class='jp-social-option'>";
				if (a.dwnload) {
						d += "<a class='jp-dwnload colrhover' href='"+a.dwnload+"'><em class='fa fa-download'></em></a>";
				}
				if (a.buylink) {
					d += "<a class='jp-buy colrhover'   href='"+a.buylink+"'><em class='fa fa-shopping-cart'></em></a>";
				}
				if (a.grvstore) {
					d += "<a class='jp-grvstore colrhover'  href='"+a.grvstore+"'>Groove</a>";
				}
				if (a.appstore) {
					d += "<a class='jp-appstore colrhover'  href='"+a.appstore+"'><em class='fa fa-apple'></em></a>";
				}
				if (a.amzstore) {
					d += "<a class='jp-amzstore colrhover'  href='"+a.amzstore+"'><em class='fa fa-amazon'></em></a>";
				}
				d += "</span>";
				}
				if(a.jptime){
