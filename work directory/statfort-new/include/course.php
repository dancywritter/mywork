<?php
	...
	function cs_course_register() {
		...
		$args = array(
			...
			'show_ui' => true,
			'query_var' => true,
			'menu_icon' => get_stylesheet_directory_uri() . '/images/admin/course-icon.png',
			'rewrite' => true,
                ...
                <div class="boxes tracklists">
                	<div id="add_track" class="poped-up">
                        ...
                        <ul class="form-elements noborder">
                            ...
                            <li class="to-field"><input type="button" value="Add Subject to List" onclick="add_subject_to_list('<?php echo home_url()?>', '<?php echo get_template_directory_uri()?>')" /></li>
                        </ul>
                    </div>
            <script>
				jQuery(document).ready(function($) {
