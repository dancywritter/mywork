...
(function(b, f) {
	...
	jPlayerPlaylist.prototype = {
		...
		_createListItem: function(a) {
			var c =
				this,
				d = "<li><div class='fullwidth'><span class='counter'>1</span>",
			...
			d += "<a href='javascript:;' class='" + this.options.playlistOptions.itemClass + "' tabindex='1'><span class='jp-playpause' ><i class='fa fa-play'></i></span><span class='title-song pix-colr-alt pix-colrhvr'>" + a.title + (a.artist ?
				"</span><span class='jp-artist'>" + a.artist + "</span>":"")+"</a>";
				d += "<span class='jp-social-option'>";
				if (a.dwnload || a.dwnloadurl || a.amzstore || a.appstore || a.soundcloud || a.grvstore) {
				if (a.dwnload) {
						d += "<a class='jp-dwnload' href='"+a.dwnload+"'><i class='fa fa-download'></i></a>";
				}
				if (a.dwnloadurl) {
						d += "<a class='jp-dwnloadurl' href='"+a.dwnloadurl+"'><i class='fa fa-link'></i></a>";
				}
				if (a.soundcloud) {
				...
				function counter() {
					jQuery(".jp-playlist li") .each(function(index, el) {
						var a = jQuery(this).index()
						jQuery(this).find(".counter").text(a+1+".")
					}); 
				}
			return d += "</div></li>"
		},
