...
function closepopedup_social(id){
  var $ = jQuery;
	...
	function update_title(id){
		var val;
		val = jQuery('#var_pb_sermon_track_title'+id).val();
		jQuery('#var_pb_sermon_track_title'+id).html(val);
	}
...
function related_title_toggle_inside_post(id){
	...
	function add_track_to_list(home_url, theme_url){
		...
		'&var_pb_sermon_track_title=' + jQuery("#var_pb_sermon_track_title").val() +
		'&var_pb_sermon_speaker=' + jQuery("#var_pb_sermon_speaker").val() +
		'&var_pb_sermon_track_mp3_url=' + jQuery("#var_pb_sermon_track_mp3_url").val() +
		'&var_pb_sermon_track_buy_mp3=' + jQuery("#var_pb_sermon_track_buy_mp3").val() +'&action=px_add_sermon_to_list';
		...
		jQuery.ajax({
			...
			success:function(response){
				...
				jQuery("#var_pb_sermon_track_title").val("Sermon Title");
				jQuery("#var_pb_sermon_speaker").val("");
				jQuery("#var_pb_sermon_track_mp3_url").val("");
				jQuery("#var_pb_sermon_track_buy_mp3").val("");
			}
		});
		//return false;
	}		
	var counter_subject = 0;
	function add_subject_to_list(home_url, theme_url){
		counter_subject++;
