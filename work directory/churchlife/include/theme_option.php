        ...
        <div class="col1">
            <div class="main-nav">
                 <ul class="sub-menu categoryitems" style="display:block">
                    ...
                    <li><i class="fa fa-columns"></i><a href="#tab-manage-announcement" onClick="toggleDiv(this.hash);return false;">Home Page Announcement</a></li>
        ...
        <div class="col2">
          ...
          <div id="tab-color">
              ...
              <ul class="form-elements  noborder">
                ...
                <div class="form-elements meta-body noborder" style=" <?php if($varto_bg_option == "background_video"){echo "display:block";}else echo "display:none";?>" id="home_v2" >
                	...
                	<ul class="form-elements noborder">
                        ...
                        <li class="to-field">
                            <input type="text" name="px_home_v2_video" class="txtfield" value="<?php echo htmlspecialchars($px_theme_option['px_home_v2_video'])?>" />
                ...
                <div class="form-elements meta-body noborder" style=" <?php if($varto_bg_option == "custom-background-image"){echo "display:block";}else echo "display:none";?>" id="home_v3" >
                    ...
                    <ul class="form-elements noborder">
                        ...
                        <li class="to-field">
                        	<input id="bg_image" name="bg_image" value="<?php echo $px_theme_option['bg_image']?>" type="text" class="small {validate:{accept:'jpg|jpeg|gif|png|bmp'}" />
                			<input id="bg_image" name="bg_image" type="button" class="uploadfile left" value="Browse" />
                        	 
                            <?php if ( $px_theme_option['bg_image'] <> "" ) { ?>
                            <div class="thumb-preview" id="bg_image_img_div"> <img width="100%" height="100%" src="<?php echo $px_theme_option['bg_image']?>" /> <a href="javascript:remove_image('bg_image')" class="del">&nbsp;</a> </div>
                            <?php } ?>
            ...
            <ul class="form-elements noborder">
              ...
              <li class="full">&nbsp;</li>
              <li class="to-label">
                <label>Split area text rotator</label>
              </li>
              <li class="to-field">
              	<textarea name="px_rotation_text" rows="8" cols="20"><?php echo $px_theme_option['px_rotation_text'];?></textarea>
                <p>Enter comma seperated text for text rotation</p>
              </li>
            </ul>
          ...
          <div id="tab-head-scripts" style="display:none;">
            ...
            <div class="header-section" id="header_banner1">
              ...
              <ul class="form-elements">
                ...
                <li class="to-field">
                <label  class="to-label">WPML Languages Switcher</label>
                  <input type="hidden" name="header_languages" value="" />
                  <label class="cs-on-off">
                      <input type="checkbox" name="header_languages" <?php if ($px_theme_option['header_languages'] == "on") echo "checked" ?> />
                      <span></span>
                  </label>
                </li>
          ...
          <ul class="form-elements">
            <li class="to-field">
            <label class="to-label">Background Music Autoplay on/off</label>
              <label class="cs-on-off">
                  <input type="checkbox" name="header_track_mp3_autoplay" <?php if (isset($px_theme_option['header_track_mp3_autoplay']) && $px_theme_option['header_track_mp3_autoplay'] == "on") echo "checked" ?>/>
                  <span></span>
              </label>
            </li>
          </ul>
          <ul class="form-elements">
                <li class="to-field">
                    <label class="to-label">Background Music MP3 URL</label>
                    <input id="header_track_mp3_url" name="header_track_mp3_url" value="<?php echo $px_theme_option['header_track_mp3_url'];?>" type="text" class="small" />
                    <input id="header_track_mp3_url" name="header_track_mp3_url" type="button" class="uploadfile left" value="Browse"/>
                </li>
          </ul>
          <ul class="form-elements">
              <li class="to-label">
          ...
          <div id="tab-other" style="display:none;">
            ...
            <ul class="form-elements">
              ...
              <li class="to-field">
              <label class="to-label">Ajax</label>
                <input type="hidden" name="site_ajax" value="" />
                <label class="cs-on-off">
                    <input type="checkbox" name="site_ajax" <?php if (isset($px_theme_option['site_ajax']) &&  $px_theme_option['site_ajax'] == "on"){echo "checked";} ?> />
                    <span></span>
                </label>
          ...
          <div id="tab-manage-announcement" style="display:none;">
            ...
            <div class="opt-head">
              <h4>Home Page Announcement Settings</h4>
              <div class="clear"></div>
            </div>
            <ul class="form-elements ">
              <li class="to-label">
              ...
              <li class="to-field">
                <input type="text" name="announcement_title" size="5" value="<?php echo $px_theme_option['announcement_title']?>" />
              ...
              <table class="to-table" border="0" cellspacing="0">
                ...
                <tbody id="social_network_area">
                  ...
                  <tr id="<?php echo $px_counter_social_network;?>" style="display:none">
                    <td colspan="3">
                    <span class="theme-wrap"><a onclick="px_toggle('<?php echo $px_counter_social_network?>')" ><i class="fa fa fa-times"></i></a></span>
                    <ul class="form-elements">
                        <li class="to-label">
                          <label>Icon Path</label>
                        </li>
          ...
          <div id="tab-upload-languages" style="display:none;">
            ...
            <li class="to-field">
              <input type="text" name="trans_event_location" value="<?php echo $px_theme_option['trans_event_location']?>" />
            </li>
          </ul>
            <ul class="form-elements noborder">
              <li class="to-label">
              ...
              <li class="to-field">
                <input type="text" name="trans_sermons" value="<?php echo $px_theme_option['trans_sermons']?>" />
              </li>
            </ul>
            <ul class="form-elements noborder">
              <li class="to-label">
              ...
              <li class="to-field">
                <input type="text" name="trans_play_all" value="<?php echo $px_theme_option['trans_play_all']?>" />
              </li>
            </ul>
            <ul class="form-elements noborder">
              <li class="to-label">
                <label>Pause All</label>
              </li>
              <li class="to-field">
                <input type="text" name="trans_pause_all" value="<?php echo $px_theme_option['trans_pause_all']?>" />
              </li>
            </ul>
