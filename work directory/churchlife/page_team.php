    	...
    	<div class="team-section">
        	<?php	if ($px_node->team_title <> '') { ?>
                <header class="heading">
                    <?php	if ($px_node->team_title <> '') { ?>
                    <h2 class="headding-color section-title"><?php echo $px_node->team_title; ?></h2>
					<?php  } ?>
            ...
            <?php
				...
				?>
                <article>
                    <figure class="pix-bgcolr-alt"><?php if($image_url <> ''){?> <img src="<?php echo $image_url;?>" alt=""><?php }?></figure>
                    <div class="text">
                        <h3><?php the_title();?></h3>
                        <?php if(isset($team['designation']) && $team['designation'] <> ''){?><h6><?php echo $team['designation'];?></h6><?php }?>
                        <?php the_content(); ?>
                        <div class="followus">
                            <?php if(isset($team['twitter']) && $team['twitter'] <> ''){?><a href="<?php echo $team['twitter'];?>"><i class="fa fa-twitter-square"></i></a><?php }?>
                            <?php if(isset($team['facebook']) && $team['facebook'] <> ''){?><a href="<?php echo $team['facebook'];?>"><i class="fa fa-facebook-square"></i></a><?php }?>
                            <?php if(isset($team['google_plus']) && $team['google_plus'] <> ''){?><a href="<?php echo $team['google_plus'];?>"><i class="fa fa-google-plus-square"></i></a><?php }?>
                            <?php if(isset($team['linkedin']) && $team['linkedin'] <> ''){?><a href="<?php echo $team['linkedin'];?>"><i class="fa fa-linkedin-square"></i></a><?php }?>
                        </div>
                    </div>
                </article>
                <?php endwhile; ?>
