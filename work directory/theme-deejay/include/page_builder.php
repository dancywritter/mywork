     ...
     <div class="page-wrap page-opts event-meta-section" style="overflow:hidden; position:relative; height: 705px;">
    	<div class="add-widget">
            <div class="widgets-list">
                ...
                <a href="javascript:ajaxSubmit('px_pb_album')">Album</a>
                <a href="javascript:ajaxSubmit('px_pb_column')">Column</a>
                <a href="javascript:ajaxSubmit('px_pb_slider')">Slider</a>
                <a href="javascript:ajaxSubmit('px_pb_contact_info')">Contact Info</a>
                <a href="javascript:ajaxSubmit('px_pb_contact')">Contact Form</a>
                <a href="javascript:ajaxSubmit('px_pb_event')">Events</a>
                <a href="javascript:ajaxSubmit('px_pb_gallery')">Gallery</a>
                <a href="javascript:ajaxSubmit('px_pb_gallery_albums')">Gallery Album</a>
				...
				if ( $px_page_bulider <> "" ) {
					...
					$px_xmlObject = new SimpleXMLElement($px_page_bulider);
                        ...
                        foreach ( $px_xmlObject->children() as $px_node ){
							...
							else if ( $px_node->getName() == "album" ) { px_pb_album(1); }
							...
							else if ( $px_node->getName() == "contact_info" ) { px_pb_contact_info(1); }
					...
					$sxe = new SimpleXMLElement("<pagebuilder></pagebuilder>");
						...
						$sxe = save_layout_xml($sxe);
							if ( isset($_POST['px_orderby']) ) {
								...
								$px_counter_contact_info = 0;
 								$px_counter_column = 0;
								$px_counter_team = 0;
								$px_counter_team_node = 0;
								$px_counter_album = 0;
								$px_counter_map = 0;
								$px_counter_gal_album = 0;
 								foreach ( $_POST['px_orderby'] as $count ){
									if ( $_POST['px_orderby'][$px_counter] == "gallery" ) {
										...
										$gallery = $sxe->addChild('gallery_albums');
											$gallery->addChild('px_gal_album_header_title', $_POST['px_gal_album_header_title'][$px_counter_gal_album] );
											$gallery->addChild('px_gal_album_text', $_POST['px_gal_album_text'][$px_counter_gal_album] );
											$gallery->addChild('px_gal_album', $_POST['px_gal_album'][$px_counter_gal_album] );
											$gallery->addChild('px_gal_album_pagination', $_POST['px_gal_album_pagination'][$px_counter_gal_album] );
											$gallery->addChild('px_gal_album_media_per_page', $_POST['px_gal_album_media_per_page'][$px_counter_gal_album] );
											$gallery->addChild('gallery_albums_element_size', $_POST['gallery_albums_element_size'][$px_counter_gal_album] );
										$px_counter_gal_album++;
										...
										$px_counter_slider++;
									}else if ( $_POST['px_orderby'][$px_counter] == "album" ) {
										$album = $sxe->addChild('album');
										$album->addChild('px_album_title', htmlspecialchars($_POST['px_album_title'][$px_counter_album]) );
										$album->addChild('px_album_cat', $_POST['px_album_cat'][$px_counter_album] );
										$album->addChild('px_album_filterable', $_POST['px_album_filterable'][$px_counter_album] );
 										$album->addChild('px_album_pagination', $_POST['px_album_pagination'][$px_counter_album] );
 										$album->addChild('px_album_per_page', $_POST['px_album_per_page'][$px_counter_album] );
										$album->addChild('album_element_size', $_POST['album_element_size'][$px_counter_album] );
										$px_counter_album++;
										...
										$event->addChild('px_event_excerpt', $_POST['px_event_excerpt'][$px_counter_event] );
										...
										$px_counter_contact++;
									}else if ( $_POST['px_orderby'][$px_counter] == "contact_info" ) {
										$contact_info = $sxe->addChild('contact_info');
										$contact_info->addChild('px_contact_title', $_POST['px_contact_title'][$px_counter_contact_info] );
										$contact_info->addChild('px_contact_address', $_POST['px_contact_address'][$px_counter_contact_info] );
										$contact_info->addChild('px_contact_phone', $_POST['px_contact_phone'][$px_counter_contact_info] );
										$contact_info->addChild('px_contact_fax', $_POST['px_contact_fax'][$px_counter_contact_info] );
										$contact_info->addChild('px_contact_info_email', $_POST['px_contact_info_email'][$px_counter_contact_info] );
										$contact_info->addChild('contact_info_element_size', $_POST['contact_info_element_size'][$px_counter_contact_info] );
										$px_counter_contact_info++;
