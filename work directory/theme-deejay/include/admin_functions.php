...
function px_pb_album($die = 0){
	...
	if ( isset($_POST['action']) ) {
		...
		$px_album_cat_db = '';
		$px_album_title = '';
		$px_album_filterable_db = '';
		$px_album_pagination_db = '';
 		$px_album_per_page_db = '';
	}
	else {
		$name = $px_node->getName();
			$count_node++;
			$album_element_size = $px_node->album_element_size;
			$px_album_title = $px_node->px_album_title;
			$px_album_cat_db = $px_node->px_album_cat;
			$px_album_filterable_db = $px_node->px_album_filterable;
			$px_album_pagination_db = $px_node->px_album_pagination;
 			$px_album_per_page_db = $px_node->px_album_per_page;
			$px_counter = $post->ID.$px_node;
	}
?> 
	<div id="<?php echo $name.$px_counter?>_del" class="column parentdelete column_<?php echo $album_element_size?>" item="album" data="<?php echo element_size_data_array_index($album_element_size)?>" >
		<?php px_element_setting($name,$px_counter,$album_element_size);?>
        <div class="poped-up" id="<?php echo $name.$px_counter?>" style="border:none; background:#f8f8f8;" >
            <div class="opt-head">
            ...
            <div class="opt-conts">
            	<ul class="form-elements">
                    ...
                    <li class="to-field">
                        <input type="text" name="px_album_title[]" class="txtfield" value="<?php echo htmlspecialchars($px_album_title)?>" />
                    </li>                                            
                </ul>
                <ul class="form-elements">
                    <li class="to-label"><label>Choose Category</label></li>
                    <li class="to-field">
                        <select name="px_album_cat[]" class="dropdown">
                        	<option value="0">-- Select Category --</option>
                        	<?php show_all_cats('', '', $px_album_cat_db, "album-category");?>
                        </select>
                    </li>
                </ul>
                <ul class="form-elements">
                    ...
                    <li class="to-field">
                        <select name="px_album_filterable[]" class="dropdown">
                            <option <?php if($px_album_filterable_db=="Off")echo "selected";?> >Off</option>
                            <option <?php if($px_album_filterable_db=="On")echo "selected";?> >On</option>
                        </select>
                    </li>
                </ul>
				<ul class="form-elements">
                    <li class="to-label"><label>Pagination</label></li>
                    <li class="to-field">
                        <select name="px_album_pagination[]" class="dropdown" >
                            <option <?php if($px_album_pagination_db=="Show Pagination")echo "selected";?> >Show Pagination</option>
                            <option <?php if($px_album_pagination_db=="Single Page")echo "selected";?> >Single Page</option>
                        </select>
                    </li>
                </ul>
                <ul class="form-elements">
                    <li class="to-label"><label>No. of Album Per Page (leave blank To display all)</label></li>
                    <li class="to-field">
                        <input type="text" name="px_album_per_page[]" class="txtfield" value="<?php echo $px_album_per_page_db;?>" />
                    </li>
                </ul>
                <ul class="form-elements noborder">
                    <li class="to-label"><label></label></li>
                    <li class="to-field">
                    	<input type="hidden" name="px_orderby[]" value="album" />
                        <input type="button" value="Save" style="margin-right:10px;" onclick="javascript:show_all('<?php echo $name.$px_counter?>')" />
                    </li>
                </ul>
            </div>
...
add_action('wp_ajax_px_pb_album', 'px_pb_album');
...
function px_pb_gallery_albums($die = 0){
	...
	if ( isset($_POST['action']) ) {
			$name = $_POST['action'];
			$px_counter = $_POST['counter'];
			$gallery_albums_element_size = '50';
			$px_gal_header_title_db = '';
			$px_gal_album_db = '';
 			$px_gal_desc_db = '';
			$px_gal_album_text = '';
		...
		$name = $px_node->getName();
			$px_count_node++;
			$gallery_albums_element_size = $px_node->gallery_albums_element_size;
			$px_gal_header_title_db = $px_node->px_gal_album_header_title;
			$px_gal_album_db = $px_node->px_gal_album;
			$px_gal_album_text = $px_node->px_gal_album_text;
			$px_gal_pagination_db = $px_node->px_gal_album_pagination;
			$px_gal_media_per_page_db = $px_node->px_gal_album_media_per_page;
				$px_counter = $post->ID.$px_count_node;
	}
?> 
	<div id="<?php echo $name.$px_counter?>_del" class="column  parentdelete column_<?php echo $gallery_albums_element_size?>" item="blog" data="<?php echo element_size_data_array_index($gallery_albums_element_size)?>" >
		<?php px_element_setting($name,$px_counter,$gallery_albums_element_size);?>
		<div class="poped-up" id="<?php echo $name.$px_counter?>" style="border:none; background:#f8f8f8;" >
			<div class="opt-head">
                <h5>Edit Gallery Album Options</h5>
                <a href="javascript:show_all('<?php echo $name.$px_counter?>')" class="closeit">&nbsp;</a>
            </div>
            ...
            <div class="opt-conts">
                ...
                <ul class="form-elements">
                    ...
                    <li class="to-field">
                    	<textarea name="px_gal_album_text[]" rows="5" cols="12"><?php echo htmlspecialchars($px_gal_album_text)?></textarea>
                ...
                <ul class="form-elements">
                    ...
                    <li class="to-field">
                        <select name="px_gal_album[]" class="dropdown">
                            ...
                            ?>
                                <option <?php if($category->slug==$px_gal_album_db)echo "selected";?> value="<?php echo $category->slug; ?>"><?php echo $category->cat_name?></option>
                            <?php
								}
                            ?>
                        </select>
				...
				<ul class="form-elements" >
                    <li class="to-label"><label>No. of Media Per Page  (leave blank To display all)</label></li>
                    <li class="to-field">
...
function px_pb_event($die = 0){
	...
	if ( isset($_POST['action']) ) {
		...
		$name = $px_node->getName();
			...
			$px_event_excerpt = $px_node ->px_event_excerpt;
		...
		<div class="poped-up" id="<?php echo $name.$px_counter?>" style="border:none; background:#f8f8f8;" >
            ...
            <div class="opt-conts">
                ...
                <ul class="form-elements noborder">
                    ...
                    <li class="to-field">
                        <input type="text" name="px_event_excerpt[]" class="txtfield" value="<?php echo $px_event_excerpt; ?>" />
                    </li>
                </ul>
                <ul class="form-elements">
...
function px_pb_contact_info($die = 0){
	global $px_node, $px_count_node, $post;
	if ( isset($_POST['action']) ) {
		$name = $_POST['action'];
		$px_counter = $_POST['counter'];
		$contact_info_element_size = '50';
 		$px_contact_info_email = '';
		$px_contact_title_db = '';
		...
		$name = $px_node->getName();
			$px_count_node++;
			$contact_info_element_size = $px_node->contact_info_element_size;
			...
			$px_contact_info_email = $px_node->px_contact_info_email;
			$px_counter = $post->ID.$px_count_node;
}
?> 
	<div id="<?php echo $name.$px_counter?>_del" class="column  parentdelete column_<?php echo $contact_info_element_size?>" item="contact" data="<?php echo element_size_data_array_index($contact_info_element_size)?>" >
		<?php px_element_setting($name,$px_counter,$contact_info_element_size);?>
		<div class="poped-up" id="<?php echo $name.$px_counter?>" style="border:none; background:#f8f8f8;" >
            <div class="opt-head">
            ...
            <div class="opt-conts">
                ...
                <ul class="form-elements noborder">
                    ...
                    <li class="to-field">
                        <input type="text" name="px_contact_info_email[]" class="txtfield" value="<?php echo $px_contact_info_email;?>" />
                    </li>                    
                </ul>
                <ul class="form-elements noborder">
                    <li class="to-label"></li>
                    <li class="to-field">
                    	<input type="hidden" name="px_orderby[]" value="contact_info" />
                        <input type="button" value="Save" style="margin-right:10px;" onclick="javascript:show_all('<?php echo $name.$px_counter?>')" />
                    </li>
                </ul>
            </div>
...
add_action('wp_ajax_px_pb_contact_info', 'px_pb_contact_info');
    	...
    	<?php px_element_setting($name,$px_counter,$team_element_size);?>
       	<div class="poped-up" id="<?php echo $name.$px_counter?>" style="border:none; background:#f8f8f8;" >
            ...
            <div class="opt-conts">
                ...
                <ul class="form-elements">
                    <li class="to-label"><label>No. of Records Per Page (leave blank To display all)</label></li>
...
// Team html form for page builder end
...
?>
    <tr id="edit_track<?php echo $counter_track?>">
        <td id="album-title<?php echo $counter_track?>" style="width:80%;"><?php echo $var_pb_album_track_title?></td>
        <td class="centr" style="width:20%;">
            ...
            <div class="poped-up" id="edit_track_form<?php echo $counter_track?>">
                ...
                <ul class="form-elements noborder">
                    <li class="to-label"><label>Album Title</label></li>
                    <li class="to-field">
                        <input type="text" name="var_pb_album_track_title[]" value="<?php echo htmlspecialchars($var_pb_album_track_title)?>" id="var_pb_album_track_title<?php echo $counter_track?>" />
                    </li>
                </ul>
                <ul class="form-elements noborder">
                    <li class="to-label"><label>Album Speaker</label></li>
                    <li class="to-field">
                        <input type="text" name="var_pb_album_speaker[]" value="<?php echo htmlspecialchars($var_pb_album_speaker)?>" id="var_pb_album_speaker<?php echo $counter_track?>" />
                    </li>
                </ul>
                <ul class="form-elements noborder">
                    <li class="to-label"><label>Album MP3 URL</label></li>
                    <li class="to-field">
                        <input id="var_pb_album_track_mp3_url<?php echo $counter_track?>" name="var_pb_album_track_mp3_url[]" value="<?php echo htmlspecialchars($var_pb_album_track_mp3_url)?>" type="text" class="small" />
                        <input id="var_pb_album_track_playable<?php echo $counter_track?>" name="var_pb_album_track_playable<?php echo $counter_track?>" type="button" class="uploadfile left" value="Browse"/>
                    </li>
                </ul>
                ...
                <ul class="form-elements noborder">
                    ...
                    <li class="to-field">
                        <input type="text" name="var_pb_album_track_buy_mp3[]" value="<?php echo htmlspecialchars($var_pb_album_track_buy_mp3)?>" />
                    </li>
                </ul>
                <ul class="form-elements noborder">
                    <li class="to-label"><label></label></li>
                    <li class="to-field"><input type="button" value="Update Album" onclick="update_title(<?php echo $counter_track?>); closepopedup('edit_track_form<?php echo $counter_track?>')" /></li>
                </ul>
            </div>
        </td>
    </tr>
...
add_action('wp_ajax_px_add_album_to_list', 'px_add_album_to_list');
