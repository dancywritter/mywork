...
?>	
	<?php if ( $px_layout <> '' and $px_layout  <> "none" and $px_layout  == 'left') :  ?>
	       	...
	       	<div class="blog blog-medium">
				...
				<?php
					...
					if(is_author()){
						...
						if( $wp_query->query_vars['taxonomy']=='px_cause-category' || $wp_query->query_vars['taxonomy']=='px_cause-tag') {
                        ...
                        // pagination start
                        	if ($custom_query->found_posts > get_option('posts_per_page')) {
                            	echo "<nav class='pagination'><ul>";
									 ...
									 if ( isset($_GET['px_cause-category']) ) $qrystr .= "&px_cause-category=".$_GET['px_cause-category'];
									 if ( isset($_GET['px_cause-tag']) ) $qrystr .= "&px_cause-tag=".$_GET['px_cause-tag'];
