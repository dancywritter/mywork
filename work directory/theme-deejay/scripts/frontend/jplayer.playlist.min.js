...
(function(b, f) {
	...
	jPlayerPlaylist.prototype = {
		...
		_createListItem: function(a) {
			...
			d += "<a href='javascript:;' class='" + this.options.playlistOptions.itemClass + "' tabindex='1'><span class='jp-playpause' ><i class='fa fa-play'></i><i class='fa fa-pause'></i></span><span class='title-song pix-colr-alt pix-colrhvr'>" + a.title + (a.artist ?
				"</span><span class='jp-artist'> by " + a.artist + "</span>":"")+"</a>";
				d += "<span class='jp-social-option'>";
				if (a.buynow || a.dwnload || a.dwnloadurl || a.amzstore || a.appstore || a.soundcloud || a.grvstore) {
				if (a.buynow) {
						d += "<a class='jp-buynow' href='"+a.buynow+"'><i class='fa fa-shopping-cart'></i></a>";
				}
				if (a.dwnloadurl) {
						d += "<a class='jp-dwnloadurl' href='"+a.dwnloadurl+"'><i class='fa fa-share'></i></a>";
				}
				if (a.dwnload) {
						d += "<a class='jp-dwnload' href='"+a.dwnload+"'><i class='fa fa-download'></i></a>";
				}
				if (a.soundcloud) {
		...
		_createItemHandlers: function() {
			...
			b(this.cssSelector.playlist).off("click", "a." + this.options.playlistOptions.itemClass).on("click", "a." + this.options.playlistOptions.itemClass, function() {
				...
				var ab = b(a.cssSelector.jPlayer).data().jPlayer.status.paused;
				if (ab) {
