        ...
        <article>
            ...
            <div class="desc">
                <div class="accessories-area gallery">
                    <ul class="lightbox">
                        <?php add_to_calender(); ?>
                        <li><a class="bgcolrhvr" href="<?php the_permalink();?>"> <em class="fa fa-map-marker"></em> <?php if($cs_theme_option['trans_switcher'] == "on"){ _e('Location','AidReform');}else{ echo $cs_theme_option['trans_event_location']; } ?></a></li>
                        <?php
