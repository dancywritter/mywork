                ...
                <div class="row">
                     ...
                     <?php
							 if (is_home() || is_front_page()) {
								...
								<div class="widget-announce-section" <?php if($cs_theme_option['show_slider'] ==""){ echo 'style="margin-top: 65px;"';}?>>
                                <?php 
								...
								?>
									...
									<div class="announcement-ticker fullwidth">
											<h3 class="float-left colr"><?php echo $cs_theme_option['announcement_title'];?> <em class="fa fa-caret-right"></em></h3>
											<div class="ticker-wrapp">
												<div class="flexslider">
													...
													?>
														<li>
															<a href="<?php the_permalink();?>"><?php the_title();?></a> - <time datetime="<?php echo date('d M, Y',strtotime(get_the_date()));?>"><?php echo date('F M, Y',strtotime(get_the_date()));?></time>
														</li>
