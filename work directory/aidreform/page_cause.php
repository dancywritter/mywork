    ...
    <header class="cs-heading-title">
        ...
        <div id="filter-list">
            ...
            <ul id="filters">
                ...
                <li class="<?php if(($cs_node->cause_cat==$filter_category) || empty($cs_node->cause_cat)){echo 'bgcolr';}?>"><a href="?<?php echo $qrystr."&filter_category=".$row_cat->slug?>"><?php _e("All",'AidReform');?></a></li>
