            ...
            <div id="form_hide<?php echo $cs_counter_node;?>">
                ...
                ?>" novalidate>   
                    ...
                    <p class="comment-form-contact">
                        <label><?php if($cs_theme_option['trans_switcher']== "on"){ _e('Subject','AidReform');}else{ echo $cs_theme_option['trans_subject']; } ?><span><?php   _e('(required)','AidReform'); ?></span></label>
                        <input type="text" name="subject" id="subject" class="subjectinput {validate:{required:true}}"   value="" />
                        
                    </p>
                    <p class="comment-form-comment">
                        <label><?php if($cs_theme_option['trans_switcher']== "on"){ _e('Message','AidReform');}else{echo $cs_theme_option['trans_message']; ?><span><?php   _e('(required)','AidReform');} ?></span></label>
                    ...
                    <p class="form-submit">
                        ...
                        <input type="submit" value="<?php _e('Submit', 'AidReform'); ?>" id="submit_btn<?php echo $cs_counter_node ?>" class="backcolr">
