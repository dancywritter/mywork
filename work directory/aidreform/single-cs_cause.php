			...
			if ( $cs_cause <> "" ) {
				...
				if($payment_gross<>'0' && $cs_xmlObject->cause_goal_amount <> '0'){
						...
						if($percentage_amount>100 || $percentage_amount == '100'){
							...
							if($cs_theme_option['trans_switcher'] == "on"){ $cause_status = __('Closed','AidReform');}else{ $cause_status = $cs_theme_option['cause_status']; }
        			...
        			<!-- Row Start -->
                        ...
                        <div class="<?php echo $cs_layout; ?>">
                        	...
                        	<div class="cause-detail fullwidth">
                            	...
                            	<?php if($cs_xmlObject->cause_gallery <> ''){cs_gallery_slider($cs_xmlObject->cause_gallery);}?>

                            	<div class="text-sec">

                            <div class="progress-desc fullwidth">

                                <span class="progress-box raised-amount"> <strong>$<?php echo $payment_gross;?></strong>

                                    <?php if($cs_theme_option['trans_switcher'] == "on"){ _e('Raised','AidReform');}else{ echo $cs_theme_option['cause_raised']; }?>

                                </span>

                                <span class="progress-box donors-amount"> <strong><?php echo count($cs_xmlObject_transaction->transaction);?></strong>

                                    <?php if($cs_theme_option['trans_switcher'] == "on"){ _e('Donors','AidReform');}else{ echo $cs_theme_option['cause_donors']; }?>

                                </span>

                                <span class="progress-box goal-amount">

                                    <strong>$<?php echo $cs_xmlObject->cause_goal_amount;?></strong>

                                       <?php if($cs_theme_option['trans_switcher'] == "on"){ $trans_featured = _e('Goal','AidReform');}else{ echo $cs_theme_option['cause_goal']; }?>
                            ...
                            <div class="right-desc">
                                ...
                                <time><?php if($cs_theme_option['trans_switcher'] == "on"){ $trans_featured = _e('End Date','AidReform');}else{ echo $cs_theme_option['cause_end_date']; }?>, <?php echo date('F d, Y',strtotime($cs_xmlObject->cause_end_date));?></time>
                                ...
                                <div class="detail_text rich_editor_text fullwidth">
								 ...
								 if ( $cs_cause <> "" ) {
                                    ...
                                    <div class="donar-table">
                                        ...
                                        <h2 class="cs-section-title"><?php if($cs_theme_option['trans_switcher'] == "on"){ $trans_featured = _e('Donors','AidReform');}else{ echo $cs_theme_option['cause_donors']; }?></h2>
                                        ...
                                        <ul>
                                            ...
                                            <li><span class="counter"><?php echo $cause_cout;?></span><a><?php echo $transct->address_name;?></a><p><span><?php echo $transct->payment_gross;?> <?php echo $cs_theme_option['paypal_currency'];?></span><a><?php if($cs_theme_option['trans_switcher'] == "on"){ _e('Donation','AidReform');}else{ echo $cs_theme_option['cause_donation']; }?></a></p></li>
                     	 ...
                     	 <?php if ($cs_xmlObject->cause_related == 'on') {
                                ...
                                <figcaption>
                                    ...
                                    <div class="text">
                                        ...
                                        <h2 class="cs-post-title">
                                            ...
                                            <a href="<?php the_permalink();?>" class="colrhvr"><?php echo substr(get_the_title(), 0, 24); if(strlen(get_the_title())>24) echo '...'; ?></a>
                                        ...
                                        <div class="progress-desc fullwidth">
                                            ...
                                            <span class="progress-box">
                                                ...
                                                <strong><?php echo $cs_theme_option['paypal_currency_sign'];?><?php echo $cs_xmlObject->cause_goal_amount;?></strong>
