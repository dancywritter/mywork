                ...
                <div class="breadcrumb default-image backcolr">
                    <div class="container">
                        <div class="breadcrumb-inner">
							...
							if($cs_theme_option['beadcrumbs_type'] == 'breadcrumbs' && $cs_theme_option['show_beadcrumbs'] == 'on'){
								cs_breadcrumbs(); 
							} else if($cs_theme_option['beadcrumbs_type'] == 'custome_style' && $cs_theme_option['breadcrumb_text'] <> ''){
