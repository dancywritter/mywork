 <?php
	...
	$image_url = '';
	?>
    <div class="element_size_<?php echo $cs_node->blog_element_size; ?>  newslisting">
					...
					?>
                        ...
                        <?php if(cs_hide_figure($post_xml ,$image_url) == 'true'){ ?>
                            ...
                            <div class="text fullwidth">
                            	...
                            	<?php }?>
                                <a href="<?php the_permalink();?>" class="btnreadmore float-right"><?php if($cs_theme_option['trans_switcher'] == "on"){  _e('read more','AidReform');}else{ echo $cs_theme_option['trans_read_more']; } ?> &gt;&gt;</a>
                            </div>
                        </article>
				<?php endwhile;
                    ...
                    <article <?php post_class($no_image); ?>>
                        ...
                        <div class="blog_text webkit">
                            ...
                            <?php if($cs_node->cs_blog_description == "yes"){?>
                                    ...
                                    <?php }?>
                                     <a class="cs-readmore colr" href="<?php the_permalink(); ?>"><i class="fa fa-plus"></i><?php if($cs_theme_option['trans_switcher'] == "on"){  _e('read more','AidReform');}else{ echo $cs_theme_option['trans_read_more']; } ?></a>
