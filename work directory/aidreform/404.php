...
<!-- Columns Start - fullwidth -->
    ...
    <div class="col-md-12">
        <div class="pagenone">
            ...
            <h4><?php if($cs_theme_option['trans_switcher']== "on"){ echo _e('It seems we can not find what you are looking for.','AidReform');}else{ echo $cs_theme_option['trans_content_404']; } ?></h4>
