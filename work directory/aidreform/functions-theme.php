...
if ( ! function_exists( 'cs_next_prev_post' ) ) { 
	...
	?>
    	...
    	<div class="prevnext-post">
			...
			previous_post_link( '%link', '<i class="fa fa-chevron-left"></i>'.__('Previous','Identity').'</span>' ); 

			?>

			<?php next_post_link( '%link', __('Next','Identity').' <i class="fa fa-chevron-right"></i>' ); ?>
...
if ( ! function_exists( 'cs_featured()' ) ) {
	...
	function cs_featured(){
		...
		<li class="featured"><?php if($cs_theme_option['trans_switcher'] == "on"){ _e('Featured','AidReform');}else{ echo $cs_theme_option['trans_featured']; } ?></li><li>&nbsp;|&nbsp;</li>
	...
	global $cs_theme_option;
 	...
 	if ( $cs_theme_option['color_switcher'] == "on" ) {
		...
		if ( isset($_POST['layout_option']) ) {
			...
			$_SESSION['ar_sess_layout_option'] = $_POST['layout_option'];
                ...
                <form method="post" id="color_switcher" action="">
                	...
                	<aside class="rowside">
                        ...
                        <ul class="layoutoption selectradio">
                        	...
                        	<li><label class="label_radio <?php if($_SESSION['ar_sess_layout_option']=="wrapper")echo "active";?> "><img src="<?php echo $theme_path?>/images/admin/bg-btnwide.png" alt=""><input type="radio" name="layout_option" value="wrapper" ></label></li>

                        	<li><label class="label_radio <?php if($_SESSION['ar_sess_layout_option']=="wrapper_boxed")echo "active";?> "><img src="<?php echo $theme_path?>/images/admin/bg-btnboxed.png" alt=""><input type="radio" name="layout_option" value="wrapper_boxed" ></label></li>
                ...
                <div class="container">
					...
					if($cs_theme_option['header_cart'] == 'on'){ cs_woocommerce_header_cart(); } ?>
                    	...
                    	<div class="float-right">
                            ...
                            <?php if ($cs_theme_option['header_top_menu'] == "on"){?>
                ...
                <div id="rightheader" class="flaot-right">
                    ...
                    <div class="searcharea float-right">
                        ...
                        <div id="searchbox">
                            ...
                            <input type="text" name="s" value="<?php _e('Search for:', "AidReforms"); ?>"><button type="submit" class="bgcolr"><em class="fa fa-search"></em></button>
	...
	function cs_social_share_listing($icon_type = '', $title='true') {
		...
		$html ='<div class="social-network">';
			...
			if(isset($title) && $title==true){
				...
				if($cs_theme_option["trans_switcher"] == "on") { $html .= __("Share this post",'AidReform'); }else{  $html .=  $cs_theme_option["trans_share_this_post"];}
	...
	function cs_social_share($icon_type = '', $title='true') {
		...
		$html ='<div class="followus float-left">';
			...
			if (isset($cs_theme_option['facebook_share']) && $cs_theme_option['facebook_share'] == 'on') {
				...
				$html .='<a class="addthis_button_facebook fa fa-facebook-square fa-1x"></a>';

			}

			if (isset($cs_theme_option['twitter_share']) && $cs_theme_option['twitter_share'] == 'on') {

				$html .='<a class="addthis_button_twitter fa fa-twitter-square fa-1x"></a>';

			}

			if (isset($cs_theme_option['google_plus_share']) && $cs_theme_option['google_plus_share'] == 'on') { 

				$html .='<a class="addthis_button_google fa fa-google-plus-square fa-1x"></a>';

			}

			if (isset($cs_theme_option['pinterest_share']) && $cs_theme_option['pinterest_share'] == 'on') {

				$html .='<a class="addthis_button_pinterest fa fa-pinterest-square fa-1x"></a>';

			}

			if (isset($cs_theme_option['tumblr_share']) &&  $cs_theme_option['tumblr_share'] == 'on') { 

				$html .='<a class="addthis_button_tumblr fa fa-tumblr-square fa-1x"></a>';

			}

			if (isset($cs_theme_option['linkedin_share']) && $cs_theme_option['linkedin_share'] == 'on') {

				$html .='<a class="addthis_button_linkedin fa fa-linkedin-square fa-1x"></a>';

			}

			if (isset($cs_theme_option['cs_other_share']) && $cs_theme_option['cs_other_share'] == 'on') {

				$html .='<a class="addthis_button_compact fa fa-plus-square fa-1x"></a>';
...
register_sidebar( array(
	...
	'description' => 'This Widget Show the Content in Home page.',
                       ...
                       <form action="<?php echo home_url() ?>" id="searchform" method="get" role="search">
                       		...
                       		<?php if($type='toggle' && $type <> ''){?>
                                ...
                                <div class="search-box" style="display: block;">
                                    ...
                                    <input type="text" value="<?php _e('Search for:', "AidReform"); ?>" class="search-input" name="s">
                            ...
                            <div class="search">
                                ...
                                <input type="text" name="s" class="search-input" value="<?php _e('Search for:', "AidReform"); ?>">
                        ...
                        <div class="search_form" id="search_form">
                            ...
                            <div class="relative"> 
                                ...
                                <form action="<?php echo home_url() ?>" id="searchform" method="get" role="search">
                                    ...
                                    <input type="text" name="s" value="<?php _e('Search for:', "AidReform"); ?>"

                                           onFocus="if (this.value == '<?php _e('Search for:', "AidReform"); ?>') {
                                           ...
                                           onblur="if (this.value == '') {
                                                       ...
                                                       this.value = '<?php _e('Search for:', "AidReform"); ?>';

                                                   }">

                                    <label>

                                    	<i class="fa fa-search fa fa-2"></i>

                                        <input type="submit" value="<?php //_e('Search', "AidReform")    ?>" id="searchsubmit" class="backcolr">
...
if ( ! function_exists( 'cs_login' ) ) {
	...
	function cs_login(){ 
		 ...
		 if ( is_user_logged_in() ) { ?>
                   			 ...
                   			 <a href="<?php echo wp_logout_url("http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']); ?>"  title="<?php _e('Log out', 'AidReform');?>" class="sitemenu float-right bgcolr"><em class="fa fa-sign-out"></em>&nbsp;<?php _e('Log out', 'AidReform');?></a>

					<?php }else{?>

                    		<a href="<?php echo bloginfo('url') ?>/wp-login.php" class="login sitemenu float-right bgcolr"> <em class="fa  fa-user"></em>&nbsp;<?php _e('Log In', 'AidReform');?></a>
									...
									<article>
										...
										<?php if($thumb == "true"){?>
                                            ...
                                            <div class="text">
                                            	...
                                            	<h6><a href="<?php the_permalink();?>"><?php echo substr(get_the_title(),0,30); if ( strlen(get_the_title()) > 30) echo "..."; ?></a></h6>	
										...
										<?php }else{ ?>
											 ...
											 <div class="text">
                                            	...
                                            	<h6><a href="<?php echo get_permalink();?>"><?php echo substr(get_the_title(),0,30);if ( strlen(get_the_title()) > 30) echo "..."; ?></a></h6>	
...
class chimp_Widget_Archives extends WP_Widget {
    ...
    function chimp_Widget_Archives() {
        ...
        $this->WP_Widget('chimp_archives', 'CS: Archives', $widget_ops);
...

{
...

  {
    ...
    $widget_ops = array('classname' => 'widget-latest-event', 'description' => 'Select Event to show its countdown.' );
				...
				$newterm = get_term_by('slug', $get_post_slug, 'event-category'); 
					...
					if ( $custom_query->have_posts() <> "" ) {
                        ...
                        while ( $custom_query->have_posts() ): $custom_query->the_post();
						 ...
						 <article>
                            ...
                            <div class="text">
                                ...
                                <time datetime="<?php echo $month_event; ?>"><?php echo date("l", strtotime($cs_event_from_date)); ?>, <?php echo $event_start_time; if($event_end_time<>''){echo '-'.$event_end_time;}?></time>
 					...
 					<?php }else{
							...
							echo '<h4 class="heading-color cs-section-title">';_e( 'No results found.', 'AidReform' ); echo '</h4>';
		...
		if ((isset($_COOKIE[$this->id_base . '-' . $this->number]) && $this->hash_mailing_list_id($this->number) == $_COOKIE[$this->id_base . '-' . $this->number]) || false == $this->ns_mc_plugin->get_mcapi()) {
			...
			if ($this->successful_signup) {
                ...
                <form action="<?php echo $_SERVER['REQUEST_URI']; ?>" id="<?php echo $this->id_base . '_form-' . $this->number; ?>" method="post">
					...
					<input type="text" name="<?php echo $this->id_base . '_first_name'; ?>" value="<?php if($cs_theme_option['trans_switcher'] == "on"){ _e('First Name :','AidReform');}else{ echo $cs_theme_option['res_first_name']; }?>" />
					...
					<input type="text" name="<?php echo $this->id_base . '_last_name'; ?>" value="<?php if($cs_theme_option['trans_switcher'] == "on"){ _e('Last Name :','AidReform');}else{ echo $cs_theme_option['res_last_name']; }?>" />
...
class cs_upcomingevents_count extends WP_Widget {
	...
	function cs_upcomingevents_count() {

		$widget_ops = array('classname' => 'widget_countdown', 'description' => 'Select Event to show its countdown.');

		$this->WP_Widget('cs_upcomingevents_count', 'ChimpS : Event Countdown', $widget_ops);
				...
				if (isset($cs_event_from_date) && $cs_event_from_date <> '') {
					...
					cs_enqueue_countdown_script();
						...
						$cs_event_from_date = get_post_meta(get_the_id(), "cs_event_from_date", true);
						 ...
						 $time_left = date("H,i,s", strtotime($cs_event_from_date));
						...
						if (strtotime($cs_event_from_date) > strtotime(date('Y-m-d'))) {
                            ...
                            <figure>
                                ...
                                <?php if($image_url <> ''){ echo '<img src="'.$image_url.'" alt="" height="192" width="348" />';}?>
...
{	global $post;
    ...
    <li><a class="bgcolrhvr add_calendar_toggle<?php echo $post->ID;?> btn-toggle_cal" href="#inline-<?php echo $post->ID;?>"> <em class="fa fa-calendar"></em> add</a>
...
function cs_event_calendar($post_id = '') {
	...
	if ($cal_post) {
		...
		$cs_vcalendar->setConfig( 'directory', ABSPATH .'wp-content/themes/identity/cache' ); 
