      ...
      <div class="row"> 
        ...
        <div class="col1">
          ...
          <div class="arrowlistmenu" id="paginate-slider2">
            ...
            <ul class="categoryitems">
              ...
              <li class="tab-breadcrumbs-scripts"><a href="#tab-breadcrumbs-scripts" onClick="toggleDiv(this.hash);return false;">Breadcrumbs Settings</a></li>
            ...
            <ul class="categoryitems">
              ...
              <li class="tab-Announcement"><a href="#tab-Announcement" onClick="toggleDiv(this.hash);return false;">Home Page Announcement</a></li>
            </ul>
        ...
        <div class="col2">
          ...
          <div id="tab-color">
            ...
            <ul class="form-elements">
            	<li class="to-label">
                	<label>Banner Color Scheme</label>
              	</li>
              	<li class="to-field">
                	...
                	<p>Switch it on if you want to show custom color.</p>
              	</li>
           		<li class="to-label"><label>Select Banner Color</label></li>
                <li>
                    <input type="text" name="banner_bg_color" value="<?php echo $cs_theme_option['banner_bg_color']?>" class="bg_color" />
                    <p>Pick a custom color for banner e.g. #333</p>
                </li>
            </ul> 
            <ul class="form-elements">
              <li class="to-label">
          ...
          <div id="tab-breadcrumbs-scripts" style="display:none;">
            ...
            <ul class="form-elements" id="cs_custome_style" style=" <?php if($cs_theme_option['beadcrumbs_type'] =="" or $cs_theme_option['beadcrumbs_type'] <> "custome_style")echo "display:none"; else "display:inline"; ?>" >
              ...
              <li class="to-field">
                ...
                <p>If you want to show custom text instead of breadcurmbs.</p>
              </li>
            </ul>
          </div>
          <!-- Footer Settings -->
          ...
          <div id="tab-slider" style="display:none;">
            ...
            <ul class="form-elements" id="other_sliders" style=" <?php if($cs_theme_option['slider_type']=="" or $cs_theme_option['slider_type']=="Revolution Slider")echo "display:none"; else "display:inline"; ?>">
              ...
              <li class="to-field">
                ...
                <p>Slider images resolution should be (1280 x 574). Create new Slider from <a style="color:#06F; text-decoration:underline;" href="<?php echo get_site_url(); ?>/wp-admin/post-new.php?post_type=cs_slider">here</a></p>
              </li>
            </ul>
          ...
          <div id="tab-cause-translation" style="display:none;">
            ...
            <div class="theme-help">
              <h4>Cause Translation</h4>
              <p>Cause Translation</p>
            </div>
            <ul class="form-elements">
              <li class="to-label">
                <label>Raised</label>
            ...
            <ul class="form-elements">
              <li class="to-label">
                <label>Goal Complete Status</label>
              </li>
              <li class="to-field">
