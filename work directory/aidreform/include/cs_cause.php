                ...
                <div class="option-sec" style="margin-bottom:0;">
                    ...
                    <ul class="form-elements">
                        ...
                        <li class="to-field">
                        	...
                        	<div class="on-off"><input type="checkbox" onchange="javascript:related_title_toggle_inside_post(this)" name="cause_related" class="myClass" <?php if(empty($cause_related) || $cause_related == "on"){ echo "checked"; }?> /></div>
                    ...
                    <ul class="form-elements" id="related_post">
                        ...
                        <li class="to-field">
                             ...
                             <input id="inside_cause_related_post_title" name="cause_related_post_title" value="<?php if($cause_related_post_title <> '' ){ echo $cause_related_post_title; }else{ echo "Related Post";} ?>" type="text" class="small" />
                    ...
                    <ul class="form-elements">
                      ...
                      <ul class="form-elements ">
                        ...
                        <li class="to-label"><label>Donations On/Off</label></li>
                ...
                <div class="boxes tracklists">
                	...
                	<div id="add_ingrediant" class="poped-up">
                        ...
                        <ul class="form-elements noborder">
                            ...
                            <li class="to-field"><input type="button" value="Add Donation" onclick="add_menu_to_list('<?php echo home_url()?>', '<?php echo get_template_directory_uri()?>')" /></li>
                    ...
                    <div class="opt-head">
                        ...
                        <h4 style="padding-top:12px;">Cause Donations</h4>

                        <a href="javascript:openpopedup('add_ingrediant')" class="button">Add Donations</a>
		...
		if ( isset($_POST['cause_meta_form']) and $_POST['cause_meta_form'] == 1 ) {
			...
			{  
				...
				$sxe = new SimpleXMLElement("<cause></cause>");
					...
					if ( empty($_POST["cause_related"]) ) $_POST["cause_related"] = "";

					if ( empty($_POST["cause_related_post_title"]) ) $_POST["cause_related_post_title"] = "";

					if ( empty($_POST["cause_goal_amount"]) ) $_POST["cause_goal_amount"] = "";

					if ( empty($_POST["cause_raised_amount"]) ) $_POST["cause_raised_amount"] = "";

					if ( empty($_POST["cause_gallery"]) ) $_POST["cause_gallery"] = "";
