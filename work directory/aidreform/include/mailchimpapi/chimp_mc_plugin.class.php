...
class CHIMP_MC_Plugin {
	...
	public function get_admin_notices () {
		...
		$notice .= __('You\'ll need to set up the MailChimp signup widget plugin options before using it. ', 'AidReform') . __('You can make your changes', 'AidReform') . ' <a href="' . get_admin_url() . 'themes.php?page=cs_theme_options#tab-mailchimp-key-show">' . __('here', 'AidReform') . '.</a>';
