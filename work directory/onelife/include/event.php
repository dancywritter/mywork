                ...
                <div class="opt-conts">
                   ...
                   <ul class="form-elements">
                    ...
                    <ul class="form-elements">
                        ...
                        <li class="to-field">
                        	<div class="on-off"><input type="checkbox" onchange="javascript:related_title_toggle_inside_post(this)" name="event_related" class="myClass" <?php if(empty($event_related) || $event_related == "on"){ echo "checked"; }?> /></div>
                            <p>Enable/Disbale Related Events</p>
                        </li>
                    </ul>
                    <ul class="form-elements" id="related_post"   style="display:<?php if(empty($event_related) || $event_related == 'on'){ echo 'inline'; }else{ echo 'none';} ?>">
                        <li class="to-label"><label>Related Post Title</label></li>
                        <li class="to-field">
                             <input id="inside_event_related_post_title" name="inside_event_related_post_title" value="<?php if($inside_event_related_post_title <> '' ){ echo $inside_event_related_post_title; }else{ echo "Related Post";} ?>" type="text" class="small" />
	...
	// event-location custom fields save start
		if ( isset($_POST['event_loc_meta_form']) and $_POST['event_loc_meta_form'] == 1 ) {
			...
			function event_loc_meta_save( $post_id ) {
				...
				if (empty($_POST["subevent_loc_zoom_title"])){ $_POST["event_loc_zoom"] = "";}
