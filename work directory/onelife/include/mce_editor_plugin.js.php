                     ...
                     title : 'Shortcode',
                         onselect : function(v) { //Add shortcode data onClick
                             if(v == 'toogle'){
                                        ...
                                        tinyMCE.activeEditor.selection.setContent('[quote type="type2" align="center" color="#COLOR_CODE"]Quote Content[/quote]<br /><br />');
                                }
                             else if(v == 'button'){
                                        ...
                                        tinyMCE.activeEditor.selection.setContent('[dropcap]Dropcap Content[/dropcap]<br /><br />');
                                }
                             else if(v == 'message_box'){
                                        tinyMCE.activeEditor.selection.setContent('[message_box type="notice/simple" align="left" icon="icon-info-sign" close="yes" color="#COLOR_CODE" background="#COLOR_CODE" border_color="#COLOR_CODE" title="Message Title"]Message Content[/message_box]<br /><br />');
                                }
                             else if(v == 'frame'){
                                        ...
                                        tinyMCE.activeEditor.selection.setContent('[skills  type="skill-v1/skill-v2/skill-v3"]<br />\
                                        [skill name="skill 1" percent="60" bg_color="#000"]<br />\
                                        [skill name="skill 2" percent="70" text="moderate" bg_color="#000"]<br />\
                                        [skill name="skill 3" percent="80" bg_color="#f00"]<br />\
                                        [skill name="skill 4" percent="70" text="easy" bg_color="#000"]<br />\
                                        [/skills]<br /><br />');
                             }
                             else if(v == 'team'){
