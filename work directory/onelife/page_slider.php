...
?>
	<div class="element_size_<?php echo $cs_node->slider_element_size; ?>"> 
    <?php	if ($cs_node->slider_header_title <> '') { ?>
    	<header class="heading">
        	<h2 class="heading-color section-title"><?php echo $cs_node->slider_header_title; ?></h2>
       	</header>
    <?php  } ?>
 	<?php
		...
		// slider slug to id start
			...
			if($get_posts){
				...
				if ( $cs_node->slider_type == "Flex Slider" ) {
					cs_flex_slider('1170','487',$slider_id);
				}else{
