  ...
  $("#"+id).slideUp(800);
	...
	function new_toggle_inside_post(id){
		...
		var Data = [
			...
			{ "Class" : "column_25" , "title" : "25" , "element" : ["column", "divider", "message_box", "image_frame", "map", "video", "quote", "dropcap","pricetable","services"] },
		];
		...
		var counter_ingredient = 0;
					...
					jQuery("a.add_services") .live('click',function(){
						...
						var newElement =jQuery("<div class='clone_form'> \
								...
								<label>Link Title:</label> <input class='txtfield' type='text' name='service_link_title[]' /> \
								<label>Link URL:</label> <input class='txtfield' type='text' name='service_link_url[]' /> \
