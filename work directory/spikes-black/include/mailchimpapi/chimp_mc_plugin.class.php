...
class CHIMP_MC_Plugin {
	...
	private static $textdomain = 'Spikes';
	...
	public function get_admin_notices () {
		global $blog_id;
		$notice = '<p>';
		$notice .= __('You\'ll need to set up the MailChimp signup widget plugin options before using it. ', 'Spikes') . __('You can make your changes', 'Spikes') . ' <a href="' . get_admin_url($blog_id) . 'themes.php?page=cs_theme_options#tab-mailchimp-key-show">' . __('here', 'Spikes') . '.</a>';
		$notice .= '</p>';
		return $notice;
	}
